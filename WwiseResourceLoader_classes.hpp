...
static_assert(sizeof(UWwiseEventInfoLibrary) == 0x000048, "Wrong size on UWwiseEventInfoLibrary");
...
static_assert(sizeof(UWwiseGroupValueInfoLibrary) == 0x000048, "Wrong size on UWwiseGroupValueInfoLibrary");
...
static_assert(sizeof(UWwiseObjectInfoLibrary) == 0x000048, "Wrong size on UWwiseObjectInfoLibrary");
