...
public:
	...
	class UWBP_SkillPoint_C*                      CallFunc_Create_ReturnValue;                       // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree) == 0x000008, "Wrong alignment on WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree");
static_assert(sizeof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree) == 0x000038, "Wrong size on WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree");
static_assert(offsetof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree, EntryPoint) == 0x000000, "Member 'WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree::EntryPoint' has a wrong offset!");
static_assert(offsetof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree, CallFunc_Create_ReturnValue) == 0x000008, "Member 'WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree, CallFunc_AddChild_ReturnValue) == 0x000018, "Member 'WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree::CallFunc_AddChild_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree, CallFunc_HasAnyChildren_ReturnValue) == 0x000020, "Member 'WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree::CallFunc_HasAnyChildren_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree, Temp_int_Variable) == 0x000024, "Member 'WBP_SkillTree_C_ExecuteUbergraph_WBP_SkillTree::Temp_int_Variable' has a wrong offset!");
