...
static_assert(sizeof(UMetasoundGeneratorHandle) == 0x000100, "Wrong size on UMetasoundGeneratorHandle");
...
static_assert(sizeof(UMetasoundOutputBlueprintAccess) == 0x000048, "Wrong size on UMetasoundOutputBlueprintAccess");
...
{
public:
	TArray<class UMetasoundGeneratorHandle*>      TrackedGenerators;                                 // 0x0060(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMetaSoundOutputSubsystem) == 0x000070, "Wrong size on UMetaSoundOutputSubsystem");
static_assert(offsetof(UMetaSoundOutputSubsystem, TrackedGenerators) == 0x000060, "Member 'UMetaSoundOutputSubsystem::TrackedGenerators' has a wrong offset!");
...
{
public:
	bool                                          bAutoUpdateEnabled;                                // 0x0058(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FMetasoundFrontendClassName>    AutoUpdateDenylist;                                // 0x0060(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<struct FDefaultMetaSoundAssetAutoUpdateSettings> AutoUpdateAssetDenylist;                 // 0x0070(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	bool                                          bAutoUpdateLogWarningOnDroppedConnection;          // 0x0080(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDirectoryPath>                 DirectoriesToRegister;                             // 0x0088(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	int32                                         DenyListCacheChangeID;                             // 0x0098(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMetaSoundSettings) == 0x0000A0, "Wrong size on UMetaSoundSettings");
static_assert(offsetof(UMetaSoundSettings, bAutoUpdateEnabled) == 0x000058, "Member 'UMetaSoundSettings::bAutoUpdateEnabled' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, AutoUpdateDenylist) == 0x000060, "Member 'UMetaSoundSettings::AutoUpdateDenylist' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, AutoUpdateAssetDenylist) == 0x000070, "Member 'UMetaSoundSettings::AutoUpdateAssetDenylist' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, bAutoUpdateLogWarningOnDroppedConnection) == 0x000080, "Member 'UMetaSoundSettings::bAutoUpdateLogWarningOnDroppedConnection' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, DirectoriesToRegister) == 0x000088, "Member 'UMetaSoundSettings::DirectoriesToRegister' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, DenyListCacheChangeID) == 0x000098, "Member 'UMetaSoundSettings::DenyListCacheChangeID' has a wrong offset!");
...
static_assert(sizeof(UMetasoundEditorGraphBase) == 0x000080, "Wrong size on UMetasoundEditorGraphBase");
...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x00B8(0x01C8)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0280(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x02D0(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x0320(0x0050)(Protected, NativeAccessSpecifierProtected)
	struct FGuid                                  AssetClassID;                                      // 0x0370(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMetaSoundPatch) == 0x000380, "Wrong size on UMetaSoundPatch");
static_assert(offsetof(UMetaSoundPatch, RootMetaSoundDocument) == 0x0000B8, "Member 'UMetaSoundPatch::RootMetaSoundDocument' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferencedAssetClassKeys) == 0x000280, "Member 'UMetaSoundPatch::ReferencedAssetClassKeys' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferencedAssetClassObjects) == 0x0002D0, "Member 'UMetaSoundPatch::ReferencedAssetClassObjects' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferenceAssetClassCache) == 0x000320, "Member 'UMetaSoundPatch::ReferenceAssetClassCache' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, AssetClassID) == 0x000370, "Member 'UMetaSoundPatch::AssetClassID' has a wrong offset!");
...
public:
	...
	TArray<struct FMetaSoundAsyncAssetDependencies> LoadingDependencies;                             // 0x0058(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_68[0x198];                                     // 0x0068(0x0198)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMetaSoundAssetSubsystem) == 0x000200, "Wrong size on UMetaSoundAssetSubsystem");
static_assert(offsetof(UMetaSoundAssetSubsystem, LoadingDependencies) == 0x000058, "Member 'UMetaSoundAssetSubsystem::LoadingDependencies' has a wrong offset!");
...
{
public:
	struct FMetaSoundFrontendDocumentBuilder      Builder;                                           // 0x0048(0x0030)(Protected, NativeAccessSpecifierProtected)
	bool                                          bIsAttached;                                       // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMetaSoundBuilderBase) == 0x000080, "Wrong size on UMetaSoundBuilderBase");
static_assert(offsetof(UMetaSoundBuilderBase, Builder) == 0x000048, "Member 'UMetaSoundBuilderBase::Builder' has a wrong offset!");
static_assert(offsetof(UMetaSoundBuilderBase, bIsAttached) == 0x000078, "Member 'UMetaSoundBuilderBase::bIsAttached' has a wrong offset!");
...
static_assert(sizeof(UMetaSoundPatchBuilder) == 0x000080, "Wrong size on UMetaSoundPatchBuilder");
...
static_assert(sizeof(UMetaSoundSourceBuilder) == 0x000088, "Wrong size on UMetaSoundSourceBuilder");
...
public:
	uint8                                         Pad_50[0x8];                                       // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, class UMetaSoundBuilderBase*> NamedBuilders;                                   // 0x0058(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	TMap<class FName, TWeakObjectPtr<class UMetaSoundBuilderBase>> AssetBuilders;                    // 0x00A8(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMetaSoundBuilderSubsystem) == 0x0000F8, "Wrong size on UMetaSoundBuilderSubsystem");
static_assert(offsetof(UMetaSoundBuilderSubsystem, NamedBuilders) == 0x000058, "Member 'UMetaSoundBuilderSubsystem::NamedBuilders' has a wrong offset!");
static_assert(offsetof(UMetaSoundBuilderSubsystem, AssetBuilders) == 0x0000A8, "Member 'UMetaSoundBuilderSubsystem::AssetBuilders' has a wrong offset!");

// Class MetasoundEngine.MetaSoundSource
// 0x0410 (0x08B0 - 0x04A0)
...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x0510(0x01C8)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x06D8(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0728(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x0778(0x0050)(Protected, NativeAccessSpecifierProtected)
	EMetaSoundOutputAudioFormat                   OutputFormat;                                      // 0x07C8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7C9[0x3];                                      // 0x07C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  AssetClassID;                                      // 0x07CC(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7DC[0xD4];                                     // 0x07DC(0x00D4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMetaSoundSource) == 0x0008B0, "Wrong size on UMetaSoundSource");
...
static_assert(offsetof(UMetaSoundSource, ReferencedAssetClassKeys) == 0x0006D8, "Member 'UMetaSoundSource::ReferencedAssetClassKeys' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferencedAssetClassObjects) == 0x000728, "Member 'UMetaSoundSource::ReferencedAssetClassObjects' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferenceAssetClassCache) == 0x000778, "Member 'UMetaSoundSource::ReferenceAssetClassCache' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, OutputFormat) == 0x0007C8, "Member 'UMetaSoundSource::OutputFormat' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, AssetClassID) == 0x0007CC, "Member 'UMetaSoundSource::AssetClassID' has a wrong offset!");
