...
public:
	...
	class UWBP_TooltipPrimaryStatEntry_C*         CallFunc_Create_ReturnValue;                       // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock) == 0x000008, "Wrong alignment on WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock");
static_assert(sizeof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock) == 0x000030, "Wrong size on WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock");
static_assert(offsetof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock, EntryPoint) == 0x000000, "Member 'WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock::EntryPoint' has a wrong offset!");
static_assert(offsetof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock, CallFunc_Create_ReturnValue) == 0x000008, "Member 'WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock, CallFunc_AddChild_ReturnValue) == 0x000018, "Member 'WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock::CallFunc_AddChild_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock, Temp_int_Variable) == 0x000020, "Member 'WBP_TooltipPrimaryStatBlock_C_ExecuteUbergraph_WBP_TooltipPrimaryStatBlock::Temp_int_Variable' has a wrong offset!");
