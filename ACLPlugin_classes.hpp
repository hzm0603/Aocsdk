...
{
public:
	TArray<uint8>                                 CookedCompressedBytes;                             // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<uint64>                                CookedAnimSequenceMappings;                        // 0x0058(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_68[0x118];                                     // 0x0068(0x0118)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxStreamRequestSizeKB;                            // 0x0180(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAnimationCompressionLibraryDatabase) == 0x000188, "Wrong size on UAnimationCompressionLibraryDatabase");
static_assert(offsetof(UAnimationCompressionLibraryDatabase, CookedCompressedBytes) == 0x000048, "Member 'UAnimationCompressionLibraryDatabase::CookedCompressedBytes' has a wrong offset!");
static_assert(offsetof(UAnimationCompressionLibraryDatabase, CookedAnimSequenceMappings) == 0x000058, "Member 'UAnimationCompressionLibraryDatabase::CookedAnimSequenceMappings' has a wrong offset!");
static_assert(offsetof(UAnimationCompressionLibraryDatabase, MaxStreamRequestSizeKB) == 0x000180, "Member 'UAnimationCompressionLibraryDatabase::MaxStreamRequestSizeKB' has a wrong offset!");
...
static_assert(sizeof(UAnimBoneCompressionCodec_ACLBase) == 0x000058, "Wrong size on UAnimBoneCompressionCodec_ACLBase");
...
static_assert(sizeof(UAnimBoneCompressionCodec_ACL) == 0x000058, "Wrong size on UAnimBoneCompressionCodec_ACL");
...
{
public:
	class UAnimationCompressionLibraryDatabase*   DatabaseAsset;                                     // 0x0058(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAnimCurveCompressionCodec_ACL) == 0x000058, "Wrong size on UAnimCurveCompressionCodec_ACL");
