...
{
public:
	struct FMyPluginStruct                        MyStruct;                                          // 0x0048(0x0010)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMyPluginObject) == 0x000058, "Wrong size on UMyPluginObject");
static_assert(offsetof(UMyPluginObject, MyStruct) == 0x000048, "Member 'UMyPluginObject::MyStruct' has a wrong offset!");
