...
static_assert(sizeof(UInterchangeAnimationTrackSetNode) == 0x0000B0, "Wrong size on UInterchangeAnimationTrackSetNode");
...
static_assert(sizeof(UInterchangeAnimationTrackBaseNode) == 0x000090, "Wrong size on UInterchangeAnimationTrackBaseNode");
...
static_assert(sizeof(UInterchangeAnimationTrackSetInstanceNode) == 0x0000D0, "Wrong size on UInterchangeAnimationTrackSetInstanceNode");
...
static_assert(sizeof(UInterchangeAnimationTrackNode) == 0x0000E0, "Wrong size on UInterchangeAnimationTrackNode");
...
static_assert(sizeof(UInterchangeTransformAnimationTrackNode) == 0x0000F0, "Wrong size on UInterchangeTransformAnimationTrackNode");
...
static_assert(sizeof(UInterchangePhysicalCameraNode) == 0x0000C0, "Wrong size on UInterchangePhysicalCameraNode");
...
static_assert(sizeof(UInterchangeStandardCameraNode) == 0x0000E0, "Wrong size on UInterchangeStandardCameraNode");
...
static_assert(sizeof(UInterchangeBaseLightNode) == 0x0000C0, "Wrong size on UInterchangeBaseLightNode");
...
static_assert(sizeof(UInterchangePointLightNode) == 0x000110, "Wrong size on UInterchangePointLightNode");
...
static_assert(sizeof(UInterchangeSpotLightNode) == 0x000130, "Wrong size on UInterchangeSpotLightNode");
...
static_assert(sizeof(UInterchangeRectLightNode) == 0x000110, "Wrong size on UInterchangeRectLightNode");
...
static_assert(sizeof(UInterchangeDirectionalLightNode) == 0x0000C0, "Wrong size on UInterchangeDirectionalLightNode");
...
static_assert(sizeof(UInterchangeTextureNode) == 0x0000B0, "Wrong size on UInterchangeTextureNode");
...
static_assert(sizeof(UInterchangeTexture2DArrayNode) == 0x0000B0, "Wrong size on UInterchangeTexture2DArrayNode");
...
static_assert(sizeof(UInterchangeTextureCubeArrayNode) == 0x0000B0, "Wrong size on UInterchangeTextureCubeArrayNode");
...
static_assert(sizeof(UInterchangeTextureCubeNode) == 0x0000B0, "Wrong size on UInterchangeTextureCubeNode");
...
static_assert(sizeof(UInterchangeTextureLightProfileNode) == 0x0000B0, "Wrong size on UInterchangeTextureLightProfileNode");
...
static_assert(sizeof(UInterchangeVariantSetNode) == 0x0000C0, "Wrong size on UInterchangeVariantSetNode");
...
static_assert(sizeof(UInterchangeSceneVariantSetsNode) == 0x0000A0, "Wrong size on UInterchangeSceneVariantSetsNode");
...
static_assert(sizeof(UInterchangeVolumeTextureNode) == 0x0000B0, "Wrong size on UInterchangeVolumeTextureNode");
...
static_assert(sizeof(UInterchangeMaterialInstanceNode) == 0x000090, "Wrong size on UInterchangeMaterialInstanceNode");
...
{
public:
	uint8                                         Pad_80[0x188];                                     // 0x0080(0x0188)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInterchangeMeshNode) == 0x000208, "Wrong size on UInterchangeMeshNode");
...
{
public:
	uint8                                         Pad_80[0x2C0];                                     // 0x0080(0x02C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInterchangeSceneNode) == 0x000340, "Wrong size on UInterchangeSceneNode");
...
static_assert(sizeof(UInterchangeTexture2DNode) == 0x000148, "Wrong size on UInterchangeTexture2DNode");
...
static_assert(sizeof(UInterchangeTextureBlurNode) == 0x000148, "Wrong size on UInterchangeTextureBlurNode");
