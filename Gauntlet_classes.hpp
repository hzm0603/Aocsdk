...
static_assert(sizeof(UGauntletTestController) == 0x000050, "Wrong size on UGauntletTestController");
...
static_assert(sizeof(UGauntletTestControllerBootTest) == 0x000050, "Wrong size on UGauntletTestControllerBootTest");
...
static_assert(sizeof(UGauntletTestControllerErrorTest) == 0x000070, "Wrong size on UGauntletTestControllerErrorTest");
