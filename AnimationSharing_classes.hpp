...
{
public:
	TSoftObjectPtr<class UEnum>                   AnimationStateEnum;                                // 0x0048(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAnimationSharingStateProcessor) == 0x000070, "Wrong size on UAnimationSharingStateProcessor");
static_assert(offsetof(UAnimationSharingStateProcessor, AnimationStateEnum) == 0x000048, "Member 'UAnimationSharingStateProcessor::AnimationStateEnum' has a wrong offset!");
...
{
public:
	TArray<class AActor*>                         RegisteredActors;                                  // 0x0048(0x0010)(Edit, ZeroConstructor, Transient, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_58[0x50];                                      // 0x0058(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimationSharingStateProcessor*        StateProcessor;                                    // 0x00A8(0x0008)(Edit, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B0[0x38];                                      // 0x00B0(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAnimSequence*>                  UsedAnimationSequences;                            // 0x00E8(0x0010)(Edit, ZeroConstructor, Transient, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_F8[0x10];                                      // 0x00F8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UEnum*                                  StateEnum;                                         // 0x0108(0x0008)(Edit, ZeroConstructor, Transient, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 SharingActor;                                      // 0x0110(0x0008)(Edit, ZeroConstructor, Transient, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAnimSharingInstance, RegisteredActors) == 0x000048, "Member 'UAnimSharingInstance::RegisteredActors' has a wrong offset!");
...
{
public:
	TArray<class USkeleton*>                      Skeletons;                                         // 0x0048(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UAnimSharingInstance*>           PerSkeletonData;                                   // 0x0058(0x0010)(Edit, ZeroConstructor, Transient, EditConst, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAnimationSharingManager) == 0x0000A8, "Wrong size on UAnimationSharingManager");
static_assert(offsetof(UAnimationSharingManager, Skeletons) == 0x000048, "Member 'UAnimationSharingManager::Skeletons' has a wrong offset!");
static_assert(offsetof(UAnimationSharingManager, PerSkeletonData) == 0x000058, "Member 'UAnimationSharingManager::PerSkeletonData' has a wrong offset!");
...
static_assert(sizeof(UAnimationSharingSetup) == 0x000068, "Wrong size on UAnimationSharingSetup");
static_assert(offsetof(UAnimationSharingSetup, SkeletonSetups) == 0x000048, "Member 'UAnimationSharingSetup::SkeletonSetups' has a wrong offset!");
static_assert(offsetof(UAnimationSharingSetup, ScalabilitySettings) == 0x000058, "Member 'UAnimationSharingSetup::ScalabilitySettings' has a wrong offset!");
