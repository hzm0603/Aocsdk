...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Bandit_Healer2_C">();
	}
	static class ABandit_Healer2_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABandit_Healer2_C>();
	}
};
