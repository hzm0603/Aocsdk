...
{
public:
	class UConstraintsManager*                    ConstraintsManager;                                // 0x0348(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AConstraintsActor) == 0x000350, "Wrong size on AConstraintsActor");
static_assert(offsetof(AConstraintsActor, ConstraintsManager) == 0x000348, "Member 'AConstraintsActor::ConstraintsManager' has a wrong offset!");
...
{
public:
	struct FConstraintTickFunction                ConstraintTick;                                    // 0x0048(0x0040)(NativeAccessSpecifierPublic)
	bool                                          Active;                                            // 0x0088(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UTickableConstraint, ConstraintTick) == 0x000048, "Member 'UTickableConstraint::ConstraintTick' has a wrong offset!");
static_assert(offsetof(UTickableConstraint, Active) == 0x000088, "Member 'UTickableConstraint::Active' has a wrong offset!");
...
{
public:
	FMulticastSparseDelegateProperty_             OnConstraintAdded_BP;                              // 0x0048(0x0001)(InstancedReference, BlueprintAssignable, NoDestructor, NativeAccessSpecifierPublic)
	FMulticastSparseDelegateProperty_             OnConstraintRemoved_BP;                            // 0x0049(0x0001)(InstancedReference, BlueprintAssignable, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4A[0xE];                                       // 0x004A(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UTickableConstraint*>            Constraints;                                       // 0x0058(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UConstraintsManager) == 0x000068, "Wrong size on UConstraintsManager");
static_assert(offsetof(UConstraintsManager, OnConstraintAdded_BP) == 0x000048, "Member 'UConstraintsManager::OnConstraintAdded_BP' has a wrong offset!");
static_assert(offsetof(UConstraintsManager, OnConstraintRemoved_BP) == 0x000049, "Member 'UConstraintsManager::OnConstraintRemoved_BP' has a wrong offset!");
static_assert(offsetof(UConstraintsManager, Constraints) == 0x000058, "Member 'UConstraintsManager::Constraints' has a wrong offset!");
...
static_assert(sizeof(UConstraintsScriptingLibrary) == 0x000048, "Wrong size on UConstraintsScriptingLibrary");
...
{
public:
	struct FMovieSceneObjectBindingID             ConstraintBindingID;                               // 0x0048(0x0018)(BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTransformableHandle) == 0x000078, "Wrong size on UTransformableHandle");
static_assert(offsetof(UTransformableHandle, ConstraintBindingID) == 0x000048, "Member 'UTransformableHandle::ConstraintBindingID' has a wrong offset!");
...
{
public:
	TWeakObjectPtr<class USceneComponent>         Component;                                         // 0x0078(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SocketName;                                        // 0x0080(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTransformableComponentHandle) == 0x000088, "Wrong size on UTransformableComponentHandle");
static_assert(offsetof(UTransformableComponentHandle, Component) == 0x000078, "Member 'UTransformableComponentHandle::Component' has a wrong offset!");
static_assert(offsetof(UTransformableComponentHandle, SocketName) == 0x000080, "Member 'UTransformableComponentHandle::SocketName' has a wrong offset!");
