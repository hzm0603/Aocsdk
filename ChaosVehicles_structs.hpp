...
public:
	...
	struct FRuntimeFloatCurve                     UserCurve;                                         // 0x0010(0x0090)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVehicleInputRateConfig) == 0x000008, "Wrong alignment on FVehicleInputRateConfig");
static_assert(sizeof(FVehicleInputRateConfig) == 0x0000A0, "Wrong size on FVehicleInputRateConfig");
...
{
public:
	struct FRuntimeFloatCurve                     TorqueCurve;                                       // 0x0000(0x0090)(Edit, NativeAccessSpecifierPublic)
	float                                         MaxTorque;                                         // 0x0090(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxRPM;                                            // 0x0094(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EngineIdleRPM;                                     // 0x0098(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EngineBrakeEffect;                                 // 0x009C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EngineRevUpMOI;                                    // 0x00A0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EngineRevDownRate;                                 // 0x00A4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVehicleEngineConfig) == 0x0000D0, "Wrong size on FVehicleEngineConfig");
...
static_assert(offsetof(FVehicleEngineConfig, MaxTorque) == 0x000090, "Member 'FVehicleEngineConfig::MaxTorque' has a wrong offset!");
static_assert(offsetof(FVehicleEngineConfig, MaxRPM) == 0x000094, "Member 'FVehicleEngineConfig::MaxRPM' has a wrong offset!");
static_assert(offsetof(FVehicleEngineConfig, EngineIdleRPM) == 0x000098, "Member 'FVehicleEngineConfig::EngineIdleRPM' has a wrong offset!");
static_assert(offsetof(FVehicleEngineConfig, EngineBrakeEffect) == 0x00009C, "Member 'FVehicleEngineConfig::EngineBrakeEffect' has a wrong offset!");
static_assert(offsetof(FVehicleEngineConfig, EngineRevUpMOI) == 0x0000A0, "Member 'FVehicleEngineConfig::EngineRevUpMOI' has a wrong offset!");
static_assert(offsetof(FVehicleEngineConfig, EngineRevDownRate) == 0x0000A4, "Member 'FVehicleEngineConfig::EngineRevDownRate' has a wrong offset!");
...
public:
	...
	struct FRuntimeFloatCurve                     SteeringCurve;                                     // 0x0008(0x0090)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FVehicleSteeringConfig) == 0x0000E0, "Wrong size on FVehicleSteeringConfig");
