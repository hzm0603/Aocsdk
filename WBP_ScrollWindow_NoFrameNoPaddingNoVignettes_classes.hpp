...
// Package: WBP_ScrollWindow_NoFrameNoPaddingNoVignettes
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_ScrollWindow_NoFrameNoPaddingNoVignettes_C">();
	}
	static class UWBP_ScrollWindow_NoFrameNoPaddingNoVignettes_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_ScrollWindow_NoFrameNoPaddingNoVignettes_C>();
	}
};
