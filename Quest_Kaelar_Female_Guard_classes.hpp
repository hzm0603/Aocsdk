...
// Package: Quest_Kaelar_Female_Guard
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Quest_Kaelar_Female_Guard_C">();
	}
	static class AQuest_Kaelar_Female_Guard_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AQuest_Kaelar_Female_Guard_C>();
	}
};
