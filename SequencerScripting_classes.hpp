...
static_assert(sizeof(UMovieSceneScriptingKey) == 0x000060, "Wrong size on UMovieSceneScriptingKey");
...
static_assert(sizeof(UMovieSceneScriptingActorReferenceKey) == 0x000080, "Wrong size on UMovieSceneScriptingActorReferenceKey");
...
{
public:
	class FName                                   ChannelName;                                       // 0x0048(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneScriptingChannel) == 0x000050, "Wrong size on UMovieSceneScriptingChannel");
static_assert(offsetof(UMovieSceneScriptingChannel, ChannelName) == 0x000048, "Member 'UMovieSceneScriptingChannel::ChannelName' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneScriptingActorReferenceChannel) == 0x000080, "Wrong size on UMovieSceneScriptingActorReferenceChannel");
...
static_assert(sizeof(UMovieSceneScriptingBoolKey) == 0x000080, "Wrong size on UMovieSceneScriptingBoolKey");
...
static_assert(sizeof(UMovieSceneScriptingBoolChannel) == 0x000080, "Wrong size on UMovieSceneScriptingBoolChannel");
...
static_assert(sizeof(UMovieSceneScriptingByteKey) == 0x000080, "Wrong size on UMovieSceneScriptingByteKey");
...
static_assert(sizeof(UMovieSceneScriptingByteChannel) == 0x000080, "Wrong size on UMovieSceneScriptingByteChannel");
...
static_assert(sizeof(UMovieSceneScriptingDoubleKey) == 0x000080, "Wrong size on UMovieSceneScriptingDoubleKey");
...
static_assert(sizeof(UMovieSceneScriptingDoubleChannel) == 0x000080, "Wrong size on UMovieSceneScriptingDoubleChannel");
...
static_assert(sizeof(UMovieSceneScriptingEventKey) == 0x000080, "Wrong size on UMovieSceneScriptingEventKey");
...
static_assert(sizeof(UMovieSceneScriptingEventChannel) == 0x000080, "Wrong size on UMovieSceneScriptingEventChannel");
...
static_assert(sizeof(UMovieSceneScriptingActualFloatKey) == 0x000080, "Wrong size on UMovieSceneScriptingActualFloatKey");
...
static_assert(sizeof(UMovieSceneScriptingDoubleAsFloatKey) == 0x000080, "Wrong size on UMovieSceneScriptingDoubleAsFloatKey");
...
static_assert(sizeof(UMovieSceneScriptingFloatChannel) == 0x0000A0, "Wrong size on UMovieSceneScriptingFloatChannel");
...
static_assert(sizeof(UMovieSceneScriptingIntegerKey) == 0x000080, "Wrong size on UMovieSceneScriptingIntegerKey");
...
static_assert(sizeof(UMovieSceneScriptingIntegerChannel) == 0x000080, "Wrong size on UMovieSceneScriptingIntegerChannel");
...
static_assert(sizeof(UMovieSceneScriptingObjectPathKey) == 0x000080, "Wrong size on UMovieSceneScriptingObjectPathKey");
...
static_assert(sizeof(UMovieSceneScriptingObjectPathChannel) == 0x000080, "Wrong size on UMovieSceneScriptingObjectPathChannel");
...
static_assert(sizeof(UMovieSceneScriptingStringKey) == 0x000080, "Wrong size on UMovieSceneScriptingStringKey");
...
static_assert(sizeof(UMovieSceneScriptingStringChannel) == 0x000080, "Wrong size on UMovieSceneScriptingStringChannel");
...
static_assert(sizeof(UMovieSceneBindingExtensions) == 0x000048, "Wrong size on UMovieSceneBindingExtensions");
...
static_assert(sizeof(UMovieSceneEventTrackExtensions) == 0x000048, "Wrong size on UMovieSceneEventTrackExtensions");
...
static_assert(sizeof(UMovieSceneFolderExtensions) == 0x000048, "Wrong size on UMovieSceneFolderExtensions");
...
static_assert(sizeof(UMovieSceneMaterialTrackExtensions) == 0x000048, "Wrong size on UMovieSceneMaterialTrackExtensions");
...
static_assert(sizeof(UMovieScenePrimitiveMaterialTrackExtensions) == 0x000048, "Wrong size on UMovieScenePrimitiveMaterialTrackExtensions");
...
static_assert(sizeof(UMovieScenePropertyTrackExtensions) == 0x000048, "Wrong size on UMovieScenePropertyTrackExtensions");
...
static_assert(sizeof(UMovieSceneSectionExtensions) == 0x000048, "Wrong size on UMovieSceneSectionExtensions");
...
static_assert(sizeof(UMovieSceneSequenceExtensions) == 0x000048, "Wrong size on UMovieSceneSequenceExtensions");
...
static_assert(sizeof(UMovieSceneTrackExtensions) == 0x000048, "Wrong size on UMovieSceneTrackExtensions");
...
static_assert(sizeof(UMovieSceneFloatVectorTrackExtensions) == 0x000048, "Wrong size on UMovieSceneFloatVectorTrackExtensions");
...
static_assert(sizeof(UMovieSceneDoubleVectorTrackExtensions) == 0x000048, "Wrong size on UMovieSceneDoubleVectorTrackExtensions");
...
static_assert(sizeof(USequencerScriptingRangeExtensions) == 0x000048, "Wrong size on USequencerScriptingRangeExtensions");
