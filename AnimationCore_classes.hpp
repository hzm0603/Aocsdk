...
{
public:
	TMap<class FName, TWeakObjectPtr<class UObject>> DataSources;                                    // 0x0048(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAnimationDataSourceRegistry) == 0x000098, "Wrong size on UAnimationDataSourceRegistry");
static_assert(offsetof(UAnimationDataSourceRegistry, DataSources) == 0x000048, "Member 'UAnimationDataSourceRegistry::DataSources' has a wrong offset!");
