...
{
public:
	uint8                                         Pad_48[0x2C8];                                     // 0x0048(0x02C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshDescriptionBase) == 0x000310, "Wrong size on UMeshDescriptionBase");
...
static_assert(sizeof(UMeshDescriptionBaseBulkData) == 0x000048, "Wrong size on UMeshDescriptionBaseBulkData");
