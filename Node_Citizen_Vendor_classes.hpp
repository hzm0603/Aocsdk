...
static_assert(sizeof(ANode_Citizen_Vendor_C) == 0x001DD0, "Wrong size on ANode_Citizen_Vendor_C");
static_assert(offsetof(ANode_Citizen_Vendor_C, AoCNodePlot) == 0x001DC8, "Member 'ANode_Citizen_Vendor_C::AoCNodePlot' has a wrong offset!");
