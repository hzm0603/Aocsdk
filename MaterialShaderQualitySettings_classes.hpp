...
{
public:
	struct FMaterialQualityOverrides              QualityOverrides[0x4];                             // 0x0048(0x0008)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UShaderPlatformQualitySettings) == 0x000078, "Wrong size on UShaderPlatformQualitySettings");
static_assert(offsetof(UShaderPlatformQualitySettings, QualityOverrides) == 0x000048, "Member 'UShaderPlatformQualitySettings::QualityOverrides' has a wrong offset!");
...
{
public:
	TMap<class FName, class UShaderPlatformQualitySettings*> ForwardSettingMap;                                 // 0x0048(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMaterialShaderQualitySettings) == 0x000098, "Wrong size on UMaterialShaderQualitySettings");
static_assert(offsetof(UMaterialShaderQualitySettings, ForwardSettingMap) == 0x000048, "Member 'UMaterialShaderQualitySettings::ForwardSettingMap' has a wrong offset!");
