...
static_assert(sizeof(UTypedElementHandleLibrary) == 0x000048, "Wrong size on UTypedElementHandleLibrary");
...
{
public:
	uint8                                         Pad_48[0x950];                                     // 0x0048(0x0950)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTestTypedElementInterfaceA_ImplTyped) == 0x000050, "Wrong size on UTestTypedElementInterfaceA_ImplTyped");
...
static_assert(sizeof(UTestTypedElementInterfaceA_ImplUntyped) == 0x000050, "Wrong size on UTestTypedElementInterfaceA_ImplUntyped");
...
static_assert(sizeof(UTestTypedElementInterfaceBAndC_Typed) == 0x000058, "Wrong size on UTestTypedElementInterfaceBAndC_Typed");
