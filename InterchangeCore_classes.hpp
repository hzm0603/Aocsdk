...
{
public:
	class UInterchangeResultsContainer*           Results;                                           // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeFactoryBase) == 0x000050, "Wrong size on UInterchangeFactoryBase");
static_assert(offsetof(UInterchangeFactoryBase, Results) == 0x000048, "Member 'UInterchangeFactoryBase::Results' has a wrong offset!");
...
{
public:
	class FString                                 Filename;                                          // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UInterchangeSourceData) == 0x000070, "Wrong size on UInterchangeSourceData");
static_assert(offsetof(UInterchangeSourceData, Filename) == 0x000048, "Member 'UInterchangeSourceData::Filename' has a wrong offset!");
...
static_assert(sizeof(UInterchangeWriterBase) == 0x000048, "Wrong size on UInterchangeWriterBase");
...
{
public:
	class FString                                 SourceAssetName;                                   // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 DestinationAssetName;                              // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UObject>                    AssetType;                                         // 0x0068(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InterchangeKey;                                    // 0x0070(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeResult) == 0x000080, "Wrong size on UInterchangeResult");
static_assert(offsetof(UInterchangeResult, SourceAssetName) == 0x000048, "Member 'UInterchangeResult::SourceAssetName' has a wrong offset!");
static_assert(offsetof(UInterchangeResult, DestinationAssetName) == 0x000058, "Member 'UInterchangeResult::DestinationAssetName' has a wrong offset!");
static_assert(offsetof(UInterchangeResult, AssetType) == 0x000068, "Member 'UInterchangeResult::AssetType' has a wrong offset!");
static_assert(offsetof(UInterchangeResult, InterchangeKey) == 0x000070, "Member 'UInterchangeResult::InterchangeKey' has a wrong offset!");
...
static_assert(sizeof(UInterchangeResultSuccess) == 0x000080, "Wrong size on UInterchangeResultSuccess");
...
static_assert(sizeof(UInterchangeResultWarning) == 0x000080, "Wrong size on UInterchangeResultWarning");
...
static_assert(sizeof(UInterchangeResultError) == 0x000080, "Wrong size on UInterchangeResultError");
...
static_assert(sizeof(UInterchangeResultWarning_Generic) == 0x000098, "Wrong size on UInterchangeResultWarning_Generic");
static_assert(offsetof(UInterchangeResultWarning_Generic, Text) == 0x000080, "Member 'UInterchangeResultWarning_Generic::Text' has a wrong offset!");
...
static_assert(sizeof(UInterchangeResultError_Generic) == 0x000098, "Wrong size on UInterchangeResultError_Generic");
static_assert(offsetof(UInterchangeResultError_Generic, Text) == 0x000080, "Member 'UInterchangeResultError_Generic::Text' has a wrong offset!");
...
static_assert(sizeof(UInterchangeResultError_ReimportFail) == 0x000080, "Wrong size on UInterchangeResultError_ReimportFail");
...
static_assert(sizeof(UInterchangeResultDisplay_Generic) == 0x000098, "Wrong size on UInterchangeResultDisplay_Generic");
static_assert(offsetof(UInterchangeResultDisplay_Generic, Text) == 0x000080, "Member 'UInterchangeResultDisplay_Generic::Text' has a wrong offset!");
...
public:
	...
	TArray<class UInterchangeResult*>             Results;                                           // 0x0070(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UInterchangeResultsContainer) == 0x000080, "Wrong size on UInterchangeResultsContainer");
static_assert(offsetof(UInterchangeResultsContainer, Results) == 0x000070, "Member 'UInterchangeResultsContainer::Results' has a wrong offset!");
...
public:
	class UInterchangeResultsContainer*           Results;                                           // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeSourceData*                 SourceData;                                        // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeTranslatorBase) == 0x000058, "Wrong size on UInterchangeTranslatorBase");
static_assert(offsetof(UInterchangeTranslatorBase, Results) == 0x000048, "Member 'UInterchangeTranslatorBase::Results' has a wrong offset!");
static_assert(offsetof(UInterchangeTranslatorBase, SourceData) == 0x000050, "Member 'UInterchangeTranslatorBase::SourceData' has a wrong offset!");
...
static_assert(sizeof(UInterchangeBaseNode) == 0x000080, "Wrong size on UInterchangeBaseNode");
...
static_assert(sizeof(UInterchangeBaseNodeContainer) == 0x0000E8, "Wrong size on UInterchangeBaseNodeContainer");
static_assert(offsetof(UInterchangeBaseNodeContainer, Nodes) == 0x000048, "Member 'UInterchangeBaseNodeContainer::Nodes' has a wrong offset!");
...
static_assert(sizeof(UInterchangeFactoryBaseNode) == 0x000160, "Wrong size on UInterchangeFactoryBaseNode");
...
static_assert(sizeof(UInterchangeSourceNode) == 0x0000F0, "Wrong size on UInterchangeSourceNode");
...
static_assert(sizeof(UInterchangeUserDefinedAttributesAPI) == 0x000048, "Wrong size on UInterchangeUserDefinedAttributesAPI");
