...
static_assert(sizeof(UFixedFrameRateCustomTimeStep) == 0x000048, "Wrong size on UFixedFrameRateCustomTimeStep");
...
{
public:
	bool                                          bAutoDetectFormat;                                 // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGenlockedCustomTimeStep) == 0x000050, "Wrong size on UGenlockedCustomTimeStep");
static_assert(offsetof(UGenlockedCustomTimeStep, bAutoDetectFormat) == 0x000048, "Member 'UGenlockedCustomTimeStep::bAutoDetectFormat' has a wrong offset!");
...
{
public:
	struct FFrameRate                             FrameRate;                                         // 0x0050(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldBlock;                                      // 0x0058(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceSingleFrameDeltaTime;                        // 0x0059(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGenlockedFixedRateCustomTimeStep) == 0x000070, "Wrong size on UGenlockedFixedRateCustomTimeStep");
static_assert(offsetof(UGenlockedFixedRateCustomTimeStep, FrameRate) == 0x000050, "Member 'UGenlockedFixedRateCustomTimeStep::FrameRate' has a wrong offset!");
static_assert(offsetof(UGenlockedFixedRateCustomTimeStep, bShouldBlock) == 0x000058, "Member 'UGenlockedFixedRateCustomTimeStep::bShouldBlock' has a wrong offset!");
static_assert(offsetof(UGenlockedFixedRateCustomTimeStep, bForceSingleFrameDeltaTime) == 0x000059, "Member 'UGenlockedFixedRateCustomTimeStep::bForceSingleFrameDeltaTime' has a wrong offset!");
...
{
public:
	bool                                          bUseGenlockToCount;                                // 0x0050(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_51[0x27];                                      // 0x0051(0x0027)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGenlockedTimecodeProvider) == 0x000078, "Wrong size on UGenlockedTimecodeProvider");
static_assert(offsetof(UGenlockedTimecodeProvider, bUseGenlockToCount) == 0x000050, "Member 'UGenlockedTimecodeProvider::bUseGenlockToCount' has a wrong offset!");
...
static_assert(sizeof(UTimeManagementBlueprintLibrary) == 0x000048, "Wrong size on UTimeManagementBlueprintLibrary");
...
{
public:
	bool                                          bUseForSynchronization;                            // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         FrameOffset;                                       // 0x004C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTimeSynchronizationSource) == 0x000050, "Wrong size on UTimeSynchronizationSource");
static_assert(offsetof(UTimeSynchronizationSource, bUseForSynchronization) == 0x000048, "Member 'UTimeSynchronizationSource::bUseForSynchronization' has a wrong offset!");
static_assert(offsetof(UTimeSynchronizationSource, FrameOffset) == 0x00004C, "Member 'UTimeSynchronizationSource::FrameOffset' has a wrong offset!");
