...
{
public:
	float                                         LODBias;                                           // 0x00F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UImgMediaPlaybackComponent) == 0x000120, "Wrong size on UImgMediaPlaybackComponent");
static_assert(offsetof(UImgMediaPlaybackComponent, LODBias) == 0x0000F8, "Member 'UImgMediaPlaybackComponent::LODBias' has a wrong offset!");
