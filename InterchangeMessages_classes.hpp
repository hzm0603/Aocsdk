...
{
public:
	class FString                                 MeshName;                                          // 0x0080(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeResultMeshWarning) == 0x000090, "Wrong size on UInterchangeResultMeshWarning");
static_assert(offsetof(UInterchangeResultMeshWarning, MeshName) == 0x000080, "Member 'UInterchangeResultMeshWarning::MeshName' has a wrong offset!");
...
static_assert(sizeof(UInterchangeResultTextureWarning) == 0x000090, "Wrong size on UInterchangeResultTextureWarning");
static_assert(offsetof(UInterchangeResultTextureWarning, TextureName) == 0x000080, "Member 'UInterchangeResultTextureWarning::TextureName' has a wrong offset!");
...
static_assert(sizeof(UInterchangeResultMeshError) == 0x000090, "Wrong size on UInterchangeResultMeshError");
static_assert(offsetof(UInterchangeResultMeshError, MeshName) == 0x000080, "Member 'UInterchangeResultMeshError::MeshName' has a wrong offset!");
...
{
public:
	class FText                                   Text;                                              // 0x0090(0x0018)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeResultMeshWarning_Generic) == 0x0000A8, "Wrong size on UInterchangeResultMeshWarning_Generic");
static_assert(offsetof(UInterchangeResultMeshWarning_Generic, Text) == 0x000090, "Member 'UInterchangeResultMeshWarning_Generic::Text' has a wrong offset!");
...
static_assert(sizeof(UInterchangeResultMeshError_Generic) == 0x0000A8, "Wrong size on UInterchangeResultMeshError_Generic");
static_assert(offsetof(UInterchangeResultMeshError_Generic, Text) == 0x000090, "Member 'UInterchangeResultMeshError_Generic::Text' has a wrong offset!");
...
{
public:
	int32                                         ExcessUVs;                                         // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeResultMeshWarning_TooManyUVs) == 0x000098, "Wrong size on UInterchangeResultMeshWarning_TooManyUVs");
static_assert(offsetof(UInterchangeResultMeshWarning_TooManyUVs, ExcessUVs) == 0x000090, "Member 'UInterchangeResultMeshWarning_TooManyUVs::ExcessUVs' has a wrong offset!");
...
public:
	class FText                                   Text;                                              // 0x0090(0x0018)(NativeAccessSpecifierPublic)
	class FString                                 MaterialName;                                      // 0x00A8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeResultTextureWarning_TextureFileDoNotExist) == 0x0000B8, "Wrong size on UInterchangeResultTextureWarning_TextureFileDoNotExist");
static_assert(offsetof(UInterchangeResultTextureWarning_TextureFileDoNotExist, Text) == 0x000090, "Member 'UInterchangeResultTextureWarning_TextureFileDoNotExist::Text' has a wrong offset!");
static_assert(offsetof(UInterchangeResultTextureWarning_TextureFileDoNotExist, MaterialName) == 0x0000A8, "Member 'UInterchangeResultTextureWarning_TextureFileDoNotExist::MaterialName' has a wrong offset!");
