...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ABP_PC_MNT_Hippogriff_C">();
	}
	static class UABP_PC_MNT_Hippogriff_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UABP_PC_MNT_Hippogriff_C>();
	}
};
