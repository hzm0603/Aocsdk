...
public:
	...
	struct FRuntimeFloatCurve                     CustomCurve;                                       // 0x0108(0x0090)(Edit, NativeAccessSpecifierPublic)
	bool                                          bFlipEasing;                                       // 0x0198(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         EasingWeight;                                      // 0x019C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClamp;                                            // 0x01A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRotationRetargetingInfo) == 0x0001B0, "Wrong size on FRotationRetargetingInfo");
...
static_assert(offsetof(FRotationRetargetingInfo, bFlipEasing) == 0x000198, "Member 'FRotationRetargetingInfo::bFlipEasing' has a wrong offset!");
static_assert(offsetof(FRotationRetargetingInfo, EasingWeight) == 0x00019C, "Member 'FRotationRetargetingInfo::EasingWeight' has a wrong offset!");
static_assert(offsetof(FRotationRetargetingInfo, bClamp) == 0x0001A0, "Member 'FRotationRetargetingInfo::bClamp' has a wrong offset!");
...
public:
	...
	struct FRotationRetargetingInfo               RetargetingSettings;                               // 0x02A0(0x01B0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x000530, "Wrong size on FAnimNode_AnimDynamics");
...
public:
	...
	struct FRuntimeFloatCurve                     TrailRelaxationSpeed;                              // 0x0150(0x0090)(Edit, NativeAccessSpecifierPublic)
	...
	struct FBoneReference                         BaseJoint;                                         // 0x0260(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	float                                         LastBoneRotationAnimAlphaBlend;                    // 0x0270(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_Trail) == 0x0002B0, "Wrong size on FAnimNode_Trail");
...
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScaleInputProcessor) == 0x0001E0, "Member 'FAnimNode_Trail::RelaxationSpeedScaleInputProcessor' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RotationLimits) == 0x000210, "Member 'FAnimNode_Trail::RotationLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RotationOffsets) == 0x000220, "Member 'FAnimNode_Trail::RotationOffsets' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, PlanarLimits) == 0x000230, "Member 'FAnimNode_Trail::PlanarLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, StretchLimit) == 0x000240, "Member 'FAnimNode_Trail::StretchLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, FakeVelocity) == 0x000248, "Member 'FAnimNode_Trail::FakeVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, BaseJoint) == 0x000260, "Member 'FAnimNode_Trail::BaseJoint' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, LastBoneRotationAnimAlphaBlend) == 0x000270, "Member 'FAnimNode_Trail::LastBoneRotationAnimAlphaBlend' has a wrong offset!");
