...
static_assert(sizeof(UDeveloperSettings) == 0x000058, "Wrong size on UDeveloperSettings");
...
static_assert(sizeof(UDeveloperSettingsBackedByCVars) == 0x000058, "Wrong size on UDeveloperSettingsBackedByCVars");
...
static_assert(sizeof(UPlatformSettings) == 0x000060, "Wrong size on UPlatformSettings");
...
{
public:
	TMap<TSubclassOf<class UPlatformSettings>, struct FPlatformSettingsInstances> SettingsMap;                                       // 0x0048(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UPlatformSettingsManager) == 0x0000A0, "Wrong size on UPlatformSettingsManager");
static_assert(offsetof(UPlatformSettingsManager, SettingsMap) == 0x000048, "Member 'UPlatformSettingsManager::SettingsMap' has a wrong offset!");
