...
public:
	...
	class FString                                 VariableCollectionDescription;                     // 0x0050(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FConsoleVariablesEditorAssetSaveData> SavedCommands;                                     // 0x0060(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UConsoleVariablesAsset) == 0x000070, "Wrong size on UConsoleVariablesAsset");
static_assert(offsetof(UConsoleVariablesAsset, VariableCollectionDescription) == 0x000050, "Member 'UConsoleVariablesAsset::VariableCollectionDescription' has a wrong offset!");
static_assert(offsetof(UConsoleVariablesAsset, SavedCommands) == 0x000060, "Member 'UConsoleVariablesAsset::SavedCommands' has a wrong offset!");
