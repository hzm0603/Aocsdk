...
{
public:
	struct FSoftClassPath                         BurnInClass;                                       // 0x0068(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCompositeOntoFinalImage;                          // 0x0088(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x2F];                                      // 0x0089(0x002F)(Fixing Size After Last Property [ Dumper-7 ])
	class UTextureRenderTarget2D*                 RenderTarget;                                      // 0x00B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMoviePipelineBurnInWidget*>     BurnInWidgetInstances;                             // 0x00C0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineBurnInSetting) == 0x0000D0, "Wrong size on UMoviePipelineBurnInSetting");
static_assert(offsetof(UMoviePipelineBurnInSetting, BurnInClass) == 0x000068, "Member 'UMoviePipelineBurnInSetting::BurnInClass' has a wrong offset!");
static_assert(offsetof(UMoviePipelineBurnInSetting, bCompositeOntoFinalImage) == 0x000088, "Member 'UMoviePipelineBurnInSetting::bCompositeOntoFinalImage' has a wrong offset!");
static_assert(offsetof(UMoviePipelineBurnInSetting, RenderTarget) == 0x0000B8, "Member 'UMoviePipelineBurnInSetting::RenderTarget' has a wrong offset!");
static_assert(offsetof(UMoviePipelineBurnInSetting, BurnInWidgetInstances) == 0x0000C0, "Member 'UMoviePipelineBurnInSetting::BurnInWidgetInstances' has a wrong offset!");
...
static_assert(sizeof(UMoviePipelineConsoleVariableSetting) == 0x000118, "Wrong size on UMoviePipelineConsoleVariableSetting");
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, ConsoleVariablePresets) == 0x000068, "Member 'UMoviePipelineConsoleVariableSetting::ConsoleVariablePresets' has a wrong offset!");
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, ConsoleVariables) == 0x000078, "Member 'UMoviePipelineConsoleVariableSetting::ConsoleVariables' has a wrong offset!");
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, StartConsoleCommands) == 0x0000C8, "Member 'UMoviePipelineConsoleVariableSetting::StartConsoleCommands' has a wrong offset!");
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, EndConsoleCommands) == 0x0000D8, "Member 'UMoviePipelineConsoleVariableSetting::EndConsoleCommands' has a wrong offset!");
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, CVars) == 0x0000E8, "Member 'UMoviePipelineConsoleVariableSetting::CVars' has a wrong offset!");
...
public:
	...
	class UTextureRenderTarget2D*                 RenderTarget;                                      // 0x0080(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineWidgetRenderer) == 0x000088, "Wrong size on UMoviePipelineWidgetRenderer");
static_assert(offsetof(UMoviePipelineWidgetRenderer, bCompositeOntoFinalImage) == 0x000068, "Member 'UMoviePipelineWidgetRenderer::bCompositeOntoFinalImage' has a wrong offset!");
static_assert(offsetof(UMoviePipelineWidgetRenderer, RenderTarget) == 0x000080, "Member 'UMoviePipelineWidgetRenderer::RenderTarget' has a wrong offset!");
