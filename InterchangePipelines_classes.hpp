...
public:
	...
	bool                                          bImportLods;                                       // 0x0109(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bBakeMeshes;                                       // 0x010A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInterchangeVertexColorImportOption           VertexColorImportOption;                           // 0x010B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FColor                                 VertexOverrideColor;                               // 0x010C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRecomputeNormals;                                 // 0x0110(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRecomputeTangents;                                // 0x0111(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseMikkTSpace;                                    // 0x0112(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bComputeWeightedNormals;                           // 0x0113(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseHighPrecisionTangentBasis;                     // 0x0114(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseFullPrecisionUVs;                              // 0x0115(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseBackwardsCompatibleF16TruncUVs;                // 0x0116(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRemoveDegenerates;                                // 0x0117(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeGenericCommonMeshesProperties) == 0x000118, "Wrong size on UInterchangeGenericCommonMeshesProperties");
...
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bImportLods) == 0x000109, "Member 'UInterchangeGenericCommonMeshesProperties::bImportLods' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bBakeMeshes) == 0x00010A, "Member 'UInterchangeGenericCommonMeshesProperties::bBakeMeshes' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, VertexColorImportOption) == 0x00010B, "Member 'UInterchangeGenericCommonMeshesProperties::VertexColorImportOption' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, VertexOverrideColor) == 0x00010C, "Member 'UInterchangeGenericCommonMeshesProperties::VertexOverrideColor' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bRecomputeNormals) == 0x000110, "Member 'UInterchangeGenericCommonMeshesProperties::bRecomputeNormals' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bRecomputeTangents) == 0x000111, "Member 'UInterchangeGenericCommonMeshesProperties::bRecomputeTangents' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bUseMikkTSpace) == 0x000112, "Member 'UInterchangeGenericCommonMeshesProperties::bUseMikkTSpace' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bComputeWeightedNormals) == 0x000113, "Member 'UInterchangeGenericCommonMeshesProperties::bComputeWeightedNormals' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bUseHighPrecisionTangentBasis) == 0x000114, "Member 'UInterchangeGenericCommonMeshesProperties::bUseHighPrecisionTangentBasis' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bUseFullPrecisionUVs) == 0x000115, "Member 'UInterchangeGenericCommonMeshesProperties::bUseFullPrecisionUVs' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bUseBackwardsCompatibleF16TruncUVs) == 0x000116, "Member 'UInterchangeGenericCommonMeshesProperties::bUseBackwardsCompatibleF16TruncUVs' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, bRemoveDegenerates) == 0x000117, "Member 'UInterchangeGenericCommonMeshesProperties::bRemoveDegenerates' has a wrong offset!");
...
{
public:
	TMap<class FString, struct FSoftObjectPath>   MaterialParents;                                   // 0x0058(0x0050)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGLTFPipelineSettings) == 0x0000B0, "Wrong size on UGLTFPipelineSettings");
static_assert(offsetof(UGLTFPipelineSettings, MaterialParents) == 0x000058, "Member 'UGLTFPipelineSettings::MaterialParents' has a wrong offset!");
...
public:
	...
	bool                                          bUseGLTFMaterialInstanceLibrary;                   // 0x0110(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeGLTFPipeline) == 0x000118, "Wrong size on UInterchangeGLTFPipeline");
static_assert(offsetof(UInterchangeGLTFPipeline, bUseGLTFMaterialInstanceLibrary) == 0x000110, "Member 'UInterchangeGLTFPipeline::bUseGLTFMaterialInstanceLibrary' has a wrong offset!");
...
{
public:
	TMap<EInterchangeMaterialXShaders, struct FSoftObjectPath> PredefinedSurfaceShaders;                          // 0x0058(0x0050)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMaterialXPipelineSettings) == 0x0000A8, "Wrong size on UMaterialXPipelineSettings");
static_assert(offsetof(UMaterialXPipelineSettings, PredefinedSurfaceShaders) == 0x000058, "Member 'UMaterialXPipelineSettings::PredefinedSurfaceShaders' has a wrong offset!");
...
{
public:
	EReimportStrategyFlags                        ReimportStrategy;                                  // 0x0108(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSourceNameForAsset;                            // 0x0109(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10A[0x6];                                      // 0x010A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AssetName;                                         // 0x0110(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ImportOffsetTranslation;                           // 0x0120(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               ImportOffsetRotation;                              // 0x0138(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         ImportOffsetUniformScale;                          // 0x0150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UInterchangeGenericCommonMeshesProperties* CommonMeshesProperties;                            // 0x0158(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties* CommonSkeletalMeshesAndAnimationsProperties;       // 0x0160(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeGenericMeshPipeline*        MeshPipeline;                                      // 0x0168(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeGenericAnimationPipeline*   AnimationPipeline;                                 // 0x0170(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeGenericMaterialPipeline*    MaterialPipeline;                                  // 0x0178(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeGenericAssetsPipeline) == 0x000198, "Wrong size on UInterchangeGenericAssetsPipeline");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ReimportStrategy) == 0x000108, "Member 'UInterchangeGenericAssetsPipeline::ReimportStrategy' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, bUseSourceNameForAsset) == 0x000109, "Member 'UInterchangeGenericAssetsPipeline::bUseSourceNameForAsset' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, AssetName) == 0x000110, "Member 'UInterchangeGenericAssetsPipeline::AssetName' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ImportOffsetTranslation) == 0x000120, "Member 'UInterchangeGenericAssetsPipeline::ImportOffsetTranslation' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ImportOffsetRotation) == 0x000138, "Member 'UInterchangeGenericAssetsPipeline::ImportOffsetRotation' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ImportOffsetUniformScale) == 0x000150, "Member 'UInterchangeGenericAssetsPipeline::ImportOffsetUniformScale' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, CommonMeshesProperties) == 0x000158, "Member 'UInterchangeGenericAssetsPipeline::CommonMeshesProperties' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, CommonSkeletalMeshesAndAnimationsProperties) == 0x000160, "Member 'UInterchangeGenericAssetsPipeline::CommonSkeletalMeshesAndAnimationsProperties' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, MeshPipeline) == 0x000168, "Member 'UInterchangeGenericAssetsPipeline::MeshPipeline' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, AnimationPipeline) == 0x000170, "Member 'UInterchangeGenericAssetsPipeline::AnimationPipeline' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericAssetsPipeline, MaterialPipeline) == 0x000178, "Member 'UInterchangeGenericAssetsPipeline::MaterialPipeline' has a wrong offset!");
...
{
public:
	bool                                          bImportMaterials;                                  // 0x0108(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_109[0x7];                                      // 0x0109(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AssetName;                                         // 0x0110(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInterchangeMaterialImportOption              MaterialImport;                                    // 0x0120(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftObjectPath                        ParentMaterial;                                    // 0x0128(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeGenericTexturePipeline*     TexturePipeline;                                   // 0x0148(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeBaseNodeContainer*          BaseNodeContainer;                                 // 0x0150(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UInterchangeGenericMaterialPipeline) == 0x0001A0, "Wrong size on UInterchangeGenericMaterialPipeline");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, bImportMaterials) == 0x000108, "Member 'UInterchangeGenericMaterialPipeline::bImportMaterials' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, AssetName) == 0x000110, "Member 'UInterchangeGenericMaterialPipeline::AssetName' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, MaterialImport) == 0x000120, "Member 'UInterchangeGenericMaterialPipeline::MaterialImport' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, ParentMaterial) == 0x000128, "Member 'UInterchangeGenericMaterialPipeline::ParentMaterial' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, TexturePipeline) == 0x000148, "Member 'UInterchangeGenericMaterialPipeline::TexturePipeline' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMaterialPipeline, BaseNodeContainer) == 0x000150, "Member 'UInterchangeGenericMaterialPipeline::BaseNodeContainer' has a wrong offset!");
...
public:
	...
	bool                                          bUpdateSkeletonReferencePose;                      // 0x0165(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCreatePhysicsAsset;                               // 0x0166(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UInterchangeGenericMeshPipeline, bUpdateSkeletonReferencePose) == 0x000165, "Member 'UInterchangeGenericMeshPipeline::bUpdateSkeletonReferencePose' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericMeshPipeline, bCreatePhysicsAsset) == 0x000166, "Member 'UInterchangeGenericMeshPipeline::bCreatePhysicsAsset' has a wrong offset!");
...
{
public:
	EReimportStrategyFlags                        ReimportPropertyStrategy;                          // 0x0108(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDeleteMissingActors;                              // 0x0109(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceReimportDeletedActors;                       // 0x010A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceReimportDeletedAssets;                       // 0x010B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDeleteMissingAssets;                              // 0x010C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsePhysicalInsteadOfStandardPerspectiveCamera;    // 0x010D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UInterchangeGenericLevelPipeline) == 0x000118, "Wrong size on UInterchangeGenericLevelPipeline");
static_assert(offsetof(UInterchangeGenericLevelPipeline, ReimportPropertyStrategy) == 0x000108, "Member 'UInterchangeGenericLevelPipeline::ReimportPropertyStrategy' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericLevelPipeline, bDeleteMissingActors) == 0x000109, "Member 'UInterchangeGenericLevelPipeline::bDeleteMissingActors' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericLevelPipeline, bForceReimportDeletedActors) == 0x00010A, "Member 'UInterchangeGenericLevelPipeline::bForceReimportDeletedActors' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericLevelPipeline, bForceReimportDeletedAssets) == 0x00010B, "Member 'UInterchangeGenericLevelPipeline::bForceReimportDeletedAssets' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericLevelPipeline, bDeleteMissingAssets) == 0x00010C, "Member 'UInterchangeGenericLevelPipeline::bDeleteMissingAssets' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericLevelPipeline, bUsePhysicalInsteadOfStandardPerspectiveCamera) == 0x00010D, "Member 'UInterchangeGenericLevelPipeline::bUsePhysicalInsteadOfStandardPerspectiveCamera' has a wrong offset!");
...
{
public:
	bool                                          bImportTextures;                                   // 0x0108(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_109[0x7];                                      // 0x0109(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AssetName;                                         // 0x0110(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowNonPowerOfTwo;                               // 0x0120(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UInterchangeBaseNodeContainer*          BaseNodeContainer;                                 // 0x0128(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UInterchangeGenericTexturePipeline) == 0x000160, "Wrong size on UInterchangeGenericTexturePipeline");
static_assert(offsetof(UInterchangeGenericTexturePipeline, bImportTextures) == 0x000108, "Member 'UInterchangeGenericTexturePipeline::bImportTextures' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericTexturePipeline, AssetName) == 0x000110, "Member 'UInterchangeGenericTexturePipeline::AssetName' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericTexturePipeline, bAllowNonPowerOfTwo) == 0x000120, "Member 'UInterchangeGenericTexturePipeline::bAllowNonPowerOfTwo' has a wrong offset!");
static_assert(offsetof(UInterchangeGenericTexturePipeline, BaseNodeContainer) == 0x000128, "Member 'UInterchangeGenericTexturePipeline::BaseNodeContainer' has a wrong offset!");
...
static_assert(sizeof(UInterchangePipelineMeshesUtilities) == 0x000148, "Wrong size on UInterchangePipelineMeshesUtilities");
