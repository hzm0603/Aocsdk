...
struct CommonButtonBase_PlayAkEvent final
{
public:
	struct FSlateSound                            Sound;                                             // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonButtonBase_PlayAkEvent) == 0x000008, "Wrong alignment on CommonButtonBase_PlayAkEvent");
static_assert(sizeof(CommonButtonBase_PlayAkEvent) == 0x000020, "Wrong size on CommonButtonBase_PlayAkEvent");
static_assert(offsetof(CommonButtonBase_PlayAkEvent, Sound) == 0x000000, "Member 'CommonButtonBase_PlayAkEvent::Sound' has a wrong offset!");
