...
static_assert(sizeof(UAnimationBudgetBlueprintLibrary) == 0x000048, "Wrong size on UAnimationBudgetBlueprintLibrary");
...
{
public:
	uint8                                         Pad_1020[0x18];                                    // 0x1020(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAutoRegisterWithBudgetAllocator : 1;              // 0x1038(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoCalculateSignificance : 1;                    // 0x1038(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bShouldUseActorRenderedFlag : 1;                   // 0x1038(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(USkeletalMeshComponentBudgeted) == 0x001040, "Wrong size on USkeletalMeshComponentBudgeted");
