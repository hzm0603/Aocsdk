...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimBP_AoC_ALL_F_Child_C">();
	}
	static class UAnimBP_AoC_ALL_F_Child_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAnimBP_AoC_ALL_F_Child_C>();
	}
};
