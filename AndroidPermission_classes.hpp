...
static_assert(sizeof(UAndroidPermissionCallbackProxy) == 0x000070, "Wrong size on UAndroidPermissionCallbackProxy");
static_assert(offsetof(UAndroidPermissionCallbackProxy, OnPermissionsGrantedDynamicDelegate) == 0x000048, "Member 'UAndroidPermissionCallbackProxy::OnPermissionsGrantedDynamicDelegate' has a wrong offset!");
...
static_assert(sizeof(UAndroidPermissionFunctionLibrary) == 0x000048, "Wrong size on UAndroidPermissionFunctionLibrary");
