...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Guy_Gearieri_Rogue_C">();
	}
	static class AGuy_Gearieri_Rogue_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AGuy_Gearieri_Rogue_C>();
	}
};
