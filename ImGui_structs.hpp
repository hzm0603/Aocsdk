...
public:
	...
	struct FRuntimeFloatCurve                     DPICurve;                                          // 0x0008(0x0090)(Edit, Config, Protected, NativeAccessSpecifierProtected)
	bool                                          bScaleWithCurve;                                   // 0x0098(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FImGuiDPIScaleInfo) == 0x000008, "Wrong alignment on FImGuiDPIScaleInfo");
static_assert(sizeof(FImGuiDPIScaleInfo) == 0x0000A0, "Wrong size on FImGuiDPIScaleInfo");
...
static_assert(offsetof(FImGuiDPIScaleInfo, bScaleWithCurve) == 0x000098, "Member 'FImGuiDPIScaleInfo::bScaleWithCurve' has a wrong offset!");
