...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// class FName                             DynamicId                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidget::SetIntrepidDynamicDriverIdMetaData(class FName DynamicId)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Widget", "SetIntrepidDynamicDriverIdMetaData");

	Params::Widget_SetIntrepidDynamicDriverIdMetaData Parms{};

	Parms.DynamicId = DynamicId;
