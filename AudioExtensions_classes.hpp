...
static_assert(sizeof(USpatializationPluginSourceSettingsBase) == 0x000048, "Wrong size on USpatializationPluginSourceSettingsBase");
...
static_assert(sizeof(USourceDataOverridePluginSourceSettingsBase) == 0x000048, "Wrong size on USourceDataOverridePluginSourceSettingsBase");
...
static_assert(sizeof(UOcclusionPluginSourceSettingsBase) == 0x000048, "Wrong size on UOcclusionPluginSourceSettingsBase");
...
{
public:
	int32                                         Version;                                           // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAudioCodecEncoderSettings) == 0x000050, "Wrong size on UAudioCodecEncoderSettings");
static_assert(offsetof(UAudioCodecEncoderSettings, Version) == 0x000048, "Member 'UAudioCodecEncoderSettings::Version' has a wrong offset!");
...
static_assert(sizeof(UAudioEndpointSettingsBase) == 0x000048, "Wrong size on UAudioEndpointSettingsBase");
...
static_assert(sizeof(UDummyEndpointSettings) == 0x000048, "Wrong size on UDummyEndpointSettings");
...
static_assert(sizeof(USoundModulatorBase) == 0x000050, "Wrong size on USoundModulatorBase");
...
static_assert(sizeof(USoundfieldEndpointSettingsBase) == 0x000048, "Wrong size on USoundfieldEndpointSettingsBase");
...
static_assert(sizeof(USoundfieldEncodingSettingsBase) == 0x000048, "Wrong size on USoundfieldEncodingSettingsBase");
...
static_assert(sizeof(USoundfieldEffectSettingsBase) == 0x000048, "Wrong size on USoundfieldEffectSettingsBase");
...
{
public:
	class USoundfieldEffectSettingsBase*          Settings;                                          // 0x0048(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USoundfieldEffectBase) == 0x000050, "Wrong size on USoundfieldEffectBase");
static_assert(offsetof(USoundfieldEffectBase, Settings) == 0x000048, "Member 'USoundfieldEffectBase::Settings' has a wrong offset!");
...
static_assert(sizeof(UWaveformTransformationBase) == 0x000048, "Wrong size on UWaveformTransformationBase");
...
{
public:
	TArray<class UWaveformTransformationBase*>    Transformations;                                   // 0x0048(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UWaveformTransformationChain) == 0x000058, "Wrong size on UWaveformTransformationChain");
static_assert(offsetof(UWaveformTransformationChain, Transformations) == 0x000048, "Member 'UWaveformTransformationChain::Transformations' has a wrong offset!");
