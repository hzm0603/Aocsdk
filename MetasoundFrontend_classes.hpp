...
static_assert(sizeof(UMetasoundParameterPack) == 0x000060, "Wrong size on UMetasoundParameterPack");
...
public:
	...
	struct FMetasoundFrontendDocument             Document;                                          // 0x0050(0x01C8)(Transient, NativeAccessSpecifierPrivate)
	TSubclassOf<class UObject>                    MetaSoundUClass;                                   // 0x0218(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMetaSoundBuilderDocument) == 0x000220, "Wrong size on UMetaSoundBuilderDocument");
static_assert(offsetof(UMetaSoundBuilderDocument, Document) == 0x000050, "Member 'UMetaSoundBuilderDocument::Document' has a wrong offset!");
static_assert(offsetof(UMetaSoundBuilderDocument, MetaSoundUClass) == 0x000218, "Member 'UMetaSoundBuilderDocument::MetaSoundUClass' has a wrong offset!");
