...
// Function UMG.Widget.SetIntrepidDynamicDriverIdMetaData
// 0x0008 (0x0008 - 0x0000)
struct Widget_SetIntrepidDynamicDriverIdMetaData final
{
public:
	class FName                                   DynamicId;                                         // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Widget_SetIntrepidDynamicDriverIdMetaData) == 0x000004, "Wrong alignment on Widget_SetIntrepidDynamicDriverIdMetaData");
static_assert(sizeof(Widget_SetIntrepidDynamicDriverIdMetaData) == 0x000008, "Wrong size on Widget_SetIntrepidDynamicDriverIdMetaData");
static_assert(offsetof(Widget_SetIntrepidDynamicDriverIdMetaData, DynamicId) == 0x000000, "Member 'Widget_SetIntrepidDynamicDriverIdMetaData::DynamicId' has a wrong offset!");
