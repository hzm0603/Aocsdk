...
static_assert(sizeof(UTypedElementSelectionSetLibrary) == 0x000048, "Wrong size on UTypedElementSelectionSetLibrary");
...
static_assert(sizeof(UTypedElementSelectionSet) == 0x0008B8, "Wrong size on UTypedElementSelectionSet");
static_assert(offsetof(UTypedElementSelectionSet, OnPreSelectionChange) == 0x000848, "Member 'UTypedElementSelectionSet::OnPreSelectionChange' has a wrong offset!");
