...
static_assert(sizeof(NPC_GraveyardGolem_AnimBP_C_ExecuteUbergraph_NPC_GraveyardGolem_AnimBP) == 0x000004, "Wrong size on NPC_GraveyardGolem_AnimBP_C_ExecuteUbergraph_NPC_GraveyardGolem_AnimBP");
