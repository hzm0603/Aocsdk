...
static_assert(sizeof(UBlendSpaceLibrary) == 0x000048, "Wrong size on UBlendSpaceLibrary");
...
static_assert(sizeof(UAnimationStateMachineLibrary) == 0x000048, "Wrong size on UAnimationStateMachineLibrary");
...
static_assert(sizeof(UAnimExecutionContextLibrary) == 0x000048, "Wrong size on UAnimExecutionContextLibrary");
...
static_assert(sizeof(UBlendSpacePlayerLibrary) == 0x000048, "Wrong size on UBlendSpacePlayerLibrary");
...
{
public:
	class FName                                   NotifyName;                                        // 0x0058(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAnimNotify_PlayMontageNotify) == 0x000060, "Wrong size on UAnimNotify_PlayMontageNotify");
static_assert(offsetof(UAnimNotify_PlayMontageNotify, NotifyName) == 0x000058, "Member 'UAnimNotify_PlayMontageNotify::NotifyName' has a wrong offset!");
...
static_assert(sizeof(UAnimNotify_PlayMontageNotifyWindow) == 0x000058, "Wrong size on UAnimNotify_PlayMontageNotifyWindow");
static_assert(offsetof(UAnimNotify_PlayMontageNotifyWindow, NotifyName) == 0x000050, "Member 'UAnimNotify_PlayMontageNotifyWindow::NotifyName' has a wrong offset!");
...
static_assert(sizeof(UBlendListBaseLibrary) == 0x000048, "Wrong size on UBlendListBaseLibrary");
...
static_assert(sizeof(UKismetAnimationLibrary) == 0x000048, "Wrong size on UKismetAnimationLibrary");
...
static_assert(sizeof(ULayeredBoneBlendLibrary) == 0x000048, "Wrong size on ULayeredBoneBlendLibrary");
...
static_assert(sizeof(ULinkedAnimGraphLibrary) == 0x000048, "Wrong size on ULinkedAnimGraphLibrary");
...
{
public:
	TMulticastInlineDelegate<void(class FName NotifyName)> OnCompleted;                                       // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FName NotifyName)> OnBlendOut;                                        // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FName NotifyName)> OnInterrupted;                                     // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FName NotifyName)> OnNotifyBegin;                                     // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FName NotifyName)> OnNotifyEnd;                                       // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPlayMontageCallbackProxy) == 0x0000C8, "Wrong size on UPlayMontageCallbackProxy");
static_assert(offsetof(UPlayMontageCallbackProxy, OnCompleted) == 0x000048, "Member 'UPlayMontageCallbackProxy::OnCompleted' has a wrong offset!");
static_assert(offsetof(UPlayMontageCallbackProxy, OnBlendOut) == 0x000058, "Member 'UPlayMontageCallbackProxy::OnBlendOut' has a wrong offset!");
static_assert(offsetof(UPlayMontageCallbackProxy, OnInterrupted) == 0x000068, "Member 'UPlayMontageCallbackProxy::OnInterrupted' has a wrong offset!");
static_assert(offsetof(UPlayMontageCallbackProxy, OnNotifyBegin) == 0x000078, "Member 'UPlayMontageCallbackProxy::OnNotifyBegin' has a wrong offset!");
...
static_assert(sizeof(USequenceEvaluatorLibrary) == 0x000048, "Wrong size on USequenceEvaluatorLibrary");
...
static_assert(sizeof(USequencePlayerLibrary) == 0x000048, "Wrong size on USequencePlayerLibrary");
...
static_assert(sizeof(ISequencerAnimationSupport) == 0x000048, "Wrong size on ISequencerAnimationSupport");
...
static_assert(sizeof(USkeletalControlLibrary) == 0x000048, "Wrong size on USkeletalControlLibrary");
