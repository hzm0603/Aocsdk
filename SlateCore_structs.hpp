...
public:
	...
	class UObject*                                AkResourceObject;                                  // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(FSlateSound, AkResourceObject) == 0x000008, "Member 'FSlateSound::AkResourceObject' has a wrong offset!");
...
static_assert(sizeof(FWindowStyle) == 0x001980, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x001350, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x001420, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x0014F0, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x0015C0, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x0015E0, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x0016B0, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x0016D0, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderColor) == 0x0017A0, "Member 'FWindowStyle::BorderColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x0017C0, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x001890, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, WindowCornerRadius) == 0x001960, "Member 'FWindowStyle::WindowCornerRadius' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderPadding) == 0x001964, "Member 'FWindowStyle::BorderPadding' has a wrong offset!");
...
public:
	...
	float                                         UniformBlockWidth;                                 // 0x3E30(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UniformBlockHeight;                                // 0x3E34(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumColumns;                                        // 0x3E38(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                IconPadding;                                       // 0x3E3C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                SeparatorPadding;                                  // 0x3E4C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                ComboButtonPadding;                                // 0x3E5C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                ButtonPadding;                                     // 0x3E6C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                CheckBoxPadding;                                   // 0x3E7C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                BlockPadding;                                      // 0x3E8C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                IndentedBlockPadding;                              // 0x3E9C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                BackgroundPadding;                                 // 0x3EAC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FDeprecateSlateVector2D                IconSize;                                          // 0x3EBC(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowLabels;                                       // 0x3EC4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3EC5[0x3];                                     // 0x3EC5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ButtonContentMaxWidth;                             // 0x3EC8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ButtonContentFillWidth;                            // 0x3ECC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FToolBarStyle, ComboButtonStyle) == 0x001F20, "Member 'FToolBarStyle::ComboButtonStyle' has a wrong offset!");
...
static_assert(offsetof(FToolBarStyle, SettingsComboButton) == 0x002930, "Member 'FToolBarStyle::SettingsComboButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsToggleButton) == 0x002F40, "Member 'FToolBarStyle::SettingsToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonStyle) == 0x003A20, "Member 'FToolBarStyle::ButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, LabelPadding) == 0x003E20, "Member 'FToolBarStyle::LabelPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockWidth) == 0x003E30, "Member 'FToolBarStyle::UniformBlockWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockHeight) == 0x003E34, "Member 'FToolBarStyle::UniformBlockHeight' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, NumColumns) == 0x003E38, "Member 'FToolBarStyle::NumColumns' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPadding) == 0x003E3C, "Member 'FToolBarStyle::IconPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x003E4C, "Member 'FToolBarStyle::SeparatorPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x003E5C, "Member 'FToolBarStyle::ComboButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x003E6C, "Member 'FToolBarStyle::ButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x003E7C, "Member 'FToolBarStyle::CheckBoxPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x003E8C, "Member 'FToolBarStyle::BlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x003E9C, "Member 'FToolBarStyle::IndentedBlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x003EAC, "Member 'FToolBarStyle::BackgroundPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconSize) == 0x003EBC, "Member 'FToolBarStyle::IconSize' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, bShowLabels) == 0x003EC4, "Member 'FToolBarStyle::bShowLabels' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentMaxWidth) == 0x003EC8, "Member 'FToolBarStyle::ButtonContentMaxWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentFillWidth) == 0x003ECC, "Member 'FToolBarStyle::ButtonContentFillWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithVisibleLabel) == 0x003ED0, "Member 'FToolBarStyle::IconPaddingWithVisibleLabel' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithCollapsedLabel) == 0x003EE0, "Member 'FToolBarStyle::IconPaddingWithCollapsedLabel' has a wrong offset!");
