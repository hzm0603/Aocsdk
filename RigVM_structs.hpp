...
public:
	...
	struct FRuntimeFloatCurve                     Curve;                                             // 0x0010(0x0090)(Edit, BlueprintVisible, EditConst, NativeAccessSpecifierPublic)
	float                                         SourceMinimum;                                     // 0x00A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SourceMaximum;                                     // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TargetMinimum;                                     // 0x00A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TargetMaximum;                                     // 0x00AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Result;                                            // 0x00B0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigVMFunction_AnimEvalRichCurve) == 0x0000B8, "Wrong size on FRigVMFunction_AnimEvalRichCurve");
...
static_assert(offsetof(FRigVMFunction_AnimEvalRichCurve, SourceMinimum) == 0x0000A0, "Member 'FRigVMFunction_AnimEvalRichCurve::SourceMinimum' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_AnimEvalRichCurve, SourceMaximum) == 0x0000A4, "Member 'FRigVMFunction_AnimEvalRichCurve::SourceMaximum' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_AnimEvalRichCurve, TargetMinimum) == 0x0000A8, "Member 'FRigVMFunction_AnimEvalRichCurve::TargetMinimum' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_AnimEvalRichCurve, TargetMaximum) == 0x0000AC, "Member 'FRigVMFunction_AnimEvalRichCurve::TargetMaximum' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_AnimEvalRichCurve, Result) == 0x0000B0, "Member 'FRigVMFunction_AnimEvalRichCurve::Result' has a wrong offset!");
...
{
public:
	struct FRuntimeFloatCurve                     Curve;                                             // 0x0008(0x0090)(Edit, BlueprintVisible, EditConst, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMFunction_AnimRichCurve) == 0x000008, "Wrong alignment on FRigVMFunction_AnimRichCurve");
static_assert(sizeof(FRigVMFunction_AnimRichCurve) == 0x000098, "Wrong size on FRigVMFunction_AnimRichCurve");
