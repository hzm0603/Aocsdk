...
static_assert(sizeof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy) == 0x0000A8, "Wrong size on UAppleImageUtilsBaseAsyncTaskBlueprintProxy");
static_assert(offsetof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy, OnSuccess) == 0x000050, "Member 'UAppleImageUtilsBaseAsyncTaskBlueprintProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy, OnFailure) == 0x000060, "Member 'UAppleImageUtilsBaseAsyncTaskBlueprintProxy::OnFailure' has a wrong offset!");
static_assert(offsetof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy, ConversionResult) == 0x000080, "Member 'UAppleImageUtilsBaseAsyncTaskBlueprintProxy::ConversionResult' has a wrong offset!");
