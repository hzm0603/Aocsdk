...
{
public:
	int32                                         AmbisonicsOrder;                                   // 0x0048(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAmbisonicsEncodingSettings) == 0x000050, "Wrong size on UAmbisonicsEncodingSettings");
static_assert(offsetof(UAmbisonicsEncodingSettings, AmbisonicsOrder) == 0x000048, "Member 'UAmbisonicsEncodingSettings::AmbisonicsOrder' has a wrong offset!");
