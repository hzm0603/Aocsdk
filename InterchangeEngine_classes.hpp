...
static_assert(sizeof(UInterchangeBlueprintPipelineBase) == 0x0000C8, "Wrong size on UInterchangeBlueprintPipelineBase");
...
static_assert(sizeof(UInterchangeFilePickerBase) == 0x000048, "Wrong size on UInterchangeFilePickerBase");
...
static_assert(sizeof(UInterchangePipelineConfigurationBase) == 0x000048, "Wrong size on UInterchangePipelineConfigurationBase");
...
{
public:
	struct FInterchangeContentImportSettings      ContentImportSettings;                             // 0x0058(0x0128)(Edit, Config, NativeAccessSpecifierPublic)
	struct FInterchangeImportSettings             SceneImportSettings;                               // 0x0180(0x0088)(Edit, Config, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   FilePickerClass;                                   // 0x0208(0x0028)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing; // 0x0230(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_231[0x7];                                      // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   GenericPipelineClass;                              // 0x0238(0x0028)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangeProjectSettings) == 0x000260, "Wrong size on UInterchangeProjectSettings");
static_assert(offsetof(UInterchangeProjectSettings, ContentImportSettings) == 0x000058, "Member 'UInterchangeProjectSettings::ContentImportSettings' has a wrong offset!");
...
static_assert(offsetof(UInterchangeProjectSettings, FilePickerClass) == 0x000208, "Member 'UInterchangeProjectSettings::FilePickerClass' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing) == 0x000230, "Member 'UInterchangeProjectSettings::bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, GenericPipelineClass) == 0x000238, "Member 'UInterchangeProjectSettings::GenericPipelineClass' has a wrong offset!");
...
{
public:
	TSoftClassPtr<class UClass>                   PythonClass;                                       // 0x0048(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangePythonPipelineBase*         GeneratedPipeline;                                 // 0x0070(0x0008)(Edit, ZeroConstructor, Transient, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 JsonDefaultProperties;                             // 0x0078(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangePythonPipelineAsset) == 0x000088, "Wrong size on UInterchangePythonPipelineAsset");
static_assert(offsetof(UInterchangePythonPipelineAsset, PythonClass) == 0x000048, "Member 'UInterchangePythonPipelineAsset::PythonClass' has a wrong offset!");
static_assert(offsetof(UInterchangePythonPipelineAsset, GeneratedPipeline) == 0x000070, "Member 'UInterchangePythonPipelineAsset::GeneratedPipeline' has a wrong offset!");
static_assert(offsetof(UInterchangePythonPipelineAsset, JsonDefaultProperties) == 0x000078, "Member 'UInterchangePythonPipelineAsset::JsonDefaultProperties' has a wrong offset!");
...
static_assert(sizeof(UInterchangeSceneImportAsset) == 0x000050, "Wrong size on UInterchangeSceneImportAsset");
...
{
public:
	struct FSoftObjectPath                        SceneImportAsset;                                  // 0x0048(0x0020)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NodeUniqueID;                                      // 0x0068(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInterchangeBaseNodeContainer*          NodeContainer;                                     // 0x0078(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UObject*>                        Pipelines;                                         // 0x0080(0x0010)(ZeroConstructor, Deprecated, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UInterchangeBaseNodeContainer*          TransientNodeContainer;                            // 0x0090(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UObject*>                        TransientPipelines;                                // 0x0098(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UInterchangeAssetImportData, SceneImportAsset) == 0x000048, "Member 'UInterchangeAssetImportData::SceneImportAsset' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, NodeUniqueID) == 0x000068, "Member 'UInterchangeAssetImportData::NodeUniqueID' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, NodeContainer) == 0x000078, "Member 'UInterchangeAssetImportData::NodeContainer' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, Pipelines) == 0x000080, "Member 'UInterchangeAssetImportData::Pipelines' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, TransientNodeContainer) == 0x000090, "Member 'UInterchangeAssetImportData::TransientNodeContainer' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, TransientPipelines) == 0x000098, "Member 'UInterchangeAssetImportData::TransientPipelines' has a wrong offset!");
...
{
public:
	TArray<struct FSoftObjectPath>                OverridePipelines;                                 // 0x0048(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInterchangePipelineStackOverride) == 0x000058, "Wrong size on UInterchangePipelineStackOverride");
static_assert(offsetof(UInterchangePipelineStackOverride, OverridePipelines) == 0x000048, "Member 'UInterchangePipelineStackOverride::OverridePipelines' has a wrong offset!");
...
static_assert(sizeof(UInterchangeManager) == 0x000200, "Wrong size on UInterchangeManager");
static_assert(offsetof(UInterchangeManager, RegisteredTranslatorsClass) == 0x0000F8, "Member 'UInterchangeManager::RegisteredTranslatorsClass' has a wrong offset!");
static_assert(offsetof(UInterchangeManager, RegisteredFactoryClasses) == 0x000148, "Member 'UInterchangeManager::RegisteredFactoryClasses' has a wrong offset!");
static_assert(offsetof(UInterchangeManager, RegisteredWriters) == 0x000198, "Member 'UInterchangeManager::RegisteredWriters' has a wrong offset!");
...
static_assert(sizeof(UInterchangeMeshUtilities) == 0x000048, "Wrong size on UInterchangeMeshUtilities");
