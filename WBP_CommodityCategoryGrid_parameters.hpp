...
static_assert(alignof(WBP_CommodityCategoryGrid_C_ExecuteUbergraph_WBP_CommodityCategoryGrid) == 0x000004, "Wrong alignment on WBP_CommodityCategoryGrid_C_ExecuteUbergraph_WBP_CommodityCategoryGrid");
