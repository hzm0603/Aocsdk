...
static_assert(sizeof(UMovieSceneGeometryCollectionSection) == 0x000148, "Wrong size on UMovieSceneGeometryCollectionSection");
static_assert(offsetof(UMovieSceneGeometryCollectionSection, Params_0) == 0x000110, "Member 'UMovieSceneGeometryCollectionSection::Params_0' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneGeometryCollectionTrack) == 0x0000D0, "Wrong size on UMovieSceneGeometryCollectionTrack");
static_assert(offsetof(UMovieSceneGeometryCollectionTrack, AnimationSections) == 0x0000C0, "Member 'UMovieSceneGeometryCollectionTrack::AnimationSections' has a wrong offset!");
