...
{
public:
	struct FSoundAttenuationSettings              OutAttenuationSettings;                            // 0x0000(0x03F8)(Parm, OutParm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MediaSoundComponent_BP_GetAttenuationSettingsToApply) == 0x000400, "Wrong size on MediaSoundComponent_BP_GetAttenuationSettingsToApply");
...
static_assert(offsetof(MediaSoundComponent_BP_GetAttenuationSettingsToApply, ReturnValue) == 0x0003F8, "Member 'MediaSoundComponent_BP_GetAttenuationSettingsToApply::ReturnValue' has a wrong offset!");
