...
public:
	...
	struct FRigVMGraphFunctionStore               GraphFunctionStore;                                // 0x0430(0x0020)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x000450, "Wrong size on URigVMBlueprintGeneratedClass");
static_assert(offsetof(URigVMBlueprintGeneratedClass, GraphFunctionStore) == 0x000430, "Member 'URigVMBlueprintGeneratedClass::GraphFunctionStore' has a wrong offset!");
...
{
public:
	class URigVMMemoryStorage*                    WorkMemoryStorageObject;                           // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class URigVMMemoryStorage*                    LiteralMemoryStorageObject;                        // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class URigVMMemoryStorage*                    DebugMemoryStorageObject;                          // 0x0058(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0x20];                                      // 0x0060(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0080(0x00A0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_120[0x8];                                      // 0x0120(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMInstructionArray                 Instructions;                                      // 0x0128(0x0010)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_138[0x8];                                      // 0x0138(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           FunctionNamesStorage;                              // 0x0140(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URigVM) == 0x0002C8, "Wrong size on URigVM");
static_assert(offsetof(URigVM, WorkMemoryStorageObject) == 0x000048, "Member 'URigVM::WorkMemoryStorageObject' has a wrong offset!");
static_assert(offsetof(URigVM, LiteralMemoryStorageObject) == 0x000050, "Member 'URigVM::LiteralMemoryStorageObject' has a wrong offset!");
static_assert(offsetof(URigVM, DebugMemoryStorageObject) == 0x000058, "Member 'URigVM::DebugMemoryStorageObject' has a wrong offset!");
static_assert(offsetof(URigVM, ByteCodeStorage) == 0x000080, "Member 'URigVM::ByteCodeStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Instructions) == 0x000128, "Member 'URigVM::Instructions' has a wrong offset!");
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x000140, "Member 'URigVM::FunctionNamesStorage' has a wrong offset!");
...
{
public:
	class FString                                 Namespace;                                         // 0x0048(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNameSpacedUserData) == 0x000120, "Wrong size on UNameSpacedUserData");
static_assert(offsetof(UNameSpacedUserData, Namespace) == 0x000048, "Member 'UNameSpacedUserData::Namespace' has a wrong offset!");
...
{
public:
	class UDataAsset*                             DataAsset;                                         // 0x0120(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UDataAssetLink, DataAsset) == 0x000120, "Member 'UDataAssetLink::DataAsset' has a wrong offset!");
...
static_assert(sizeof(URigVMMemoryStorageGeneratorClass) == 0x000300, "Wrong size on URigVMMemoryStorageGeneratorClass");
...
static_assert(sizeof(URigVMMemoryStorage) == 0x000048, "Wrong size on URigVMMemoryStorage");
...
static_assert(sizeof(URigVMNativized) == 0x0002F0, "Wrong size on URigVMNativized");
...
{
public:
	class UObject*                                Subject;                                           // 0x0048(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FRigVMUserWorkflow                     Workflow;                                          // 0x0050(0x0058)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URigVMUserWorkflowOptions) == 0x0000B8, "Wrong size on URigVMUserWorkflowOptions");
static_assert(offsetof(URigVMUserWorkflowOptions, Subject) == 0x000048, "Member 'URigVMUserWorkflowOptions::Subject' has a wrong offset!");
static_assert(offsetof(URigVMUserWorkflowOptions, Workflow) == 0x000050, "Member 'URigVMUserWorkflowOptions::Workflow' has a wrong offset!");
...
public:
	...
	class URigVM*                                 VM;                                                // 0x0078(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FRigVMExtendedExecuteContext           ExtendedExecuteContext;                            // 0x0080(0x01B8)(NativeAccessSpecifierPrivate)
	struct FRigVMDrawContainer                    DrawContainer;                                     // 0x0238(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_250[0x18];                                     // 0x0250(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           EventQueue;                                        // 0x0268(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_278[0x90];                                     // 0x0278(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAssetUserData*>                 AssetUserData;                                     // 0x0308(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URigVMHost) == 0x000358, "Wrong size on URigVMHost");
static_assert(offsetof(URigVMHost, VMRuntimeSettings) == 0x000050, "Member 'URigVMHost::VMRuntimeSettings' has a wrong offset!");
static_assert(offsetof(URigVMHost, VM) == 0x000078, "Member 'URigVMHost::VM' has a wrong offset!");
static_assert(offsetof(URigVMHost, ExtendedExecuteContext) == 0x000080, "Member 'URigVMHost::ExtendedExecuteContext' has a wrong offset!");
static_assert(offsetof(URigVMHost, DrawContainer) == 0x000238, "Member 'URigVMHost::DrawContainer' has a wrong offset!");
static_assert(offsetof(URigVMHost, EventQueue) == 0x000268, "Member 'URigVMHost::EventQueue' has a wrong offset!");
static_assert(offsetof(URigVMHost, AssetUserData) == 0x000308, "Member 'URigVMHost::AssetUserData' has a wrong offset!");
...
static_assert(sizeof(URigVMEditorSettings) == 0x000058, "Wrong size on URigVMEditorSettings");
