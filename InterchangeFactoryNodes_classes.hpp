...
static_assert(sizeof(UInterchangeAnimationTrackSetFactoryNode) == 0x000190, "Wrong size on UInterchangeAnimationTrackSetFactoryNode");
...
static_assert(sizeof(UInterchangeActorFactoryNode) == 0x000190, "Wrong size on UInterchangeActorFactoryNode");
...
static_assert(sizeof(UInterchangePhysicalCameraFactoryNode) == 0x0001D0, "Wrong size on UInterchangePhysicalCameraFactoryNode");
...
static_assert(sizeof(UInterchangeStandardCameraFactoryNode) == 0x0001F0, "Wrong size on UInterchangeStandardCameraFactoryNode");
...
static_assert(sizeof(UInterchangeBaseLightFactoryNode) == 0x0001D0, "Wrong size on UInterchangeBaseLightFactoryNode");
...
static_assert(sizeof(UInterchangeDirectionalLightFactoryNode) == 0x0001D0, "Wrong size on UInterchangeDirectionalLightFactoryNode");
...
static_assert(sizeof(UInterchangeLightFactoryNode) == 0x000200, "Wrong size on UInterchangeLightFactoryNode");
...
static_assert(sizeof(UInterchangeRectLightFactoryNode) == 0x000220, "Wrong size on UInterchangeRectLightFactoryNode");
...
static_assert(sizeof(UInterchangePointLightFactoryNode) == 0x000220, "Wrong size on UInterchangePointLightFactoryNode");
...
static_assert(sizeof(UInterchangeSpotLightFactoryNode) == 0x000240, "Wrong size on UInterchangeSpotLightFactoryNode");
...
static_assert(sizeof(UInterchangePhysicsAssetFactoryNode) == 0x000190, "Wrong size on UInterchangePhysicsAssetFactoryNode");
...
static_assert(sizeof(UInterchangeSceneVariantSetsFactoryNode) == 0x000180, "Wrong size on UInterchangeSceneVariantSetsFactoryNode");
...
static_assert(sizeof(UInterchangeSkeletonFactoryNode) == 0x0001B0, "Wrong size on UInterchangeSkeletonFactoryNode");
...
{
public:
	uint8                                         Pad_160[0x290];                                    // 0x0160(0x0290)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0340 (0x04A0 - 0x0160)
class UInterchangeAnimSequenceFactoryNode final : public UInterchangeFactoryBaseNode
{
public:
	uint8                                         Pad_160[0x340];                                    // 0x0160(0x0340)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInterchangeAnimSequenceFactoryNode) == 0x0004A0, "Wrong size on UInterchangeAnimSequenceFactoryNode");
...
static_assert(sizeof(UInterchangeMaterialExpressionFactoryNode) == 0x000170, "Wrong size on UInterchangeMaterialExpressionFactoryNode");
...
static_assert(sizeof(UInterchangeMaterialFunctionCallExpressionFactoryNode) == 0x000180, "Wrong size on UInterchangeMaterialFunctionCallExpressionFactoryNode");
...
static_assert(sizeof(UInterchangeMeshActorFactoryNode) == 0x000228, "Wrong size on UInterchangeMeshActorFactoryNode");
...
{
public:
	uint8                                         Pad_160[0x170];                                    // 0x0160(0x0170)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInterchangeSceneImportAssetFactoryNode) == 0x000160, "Wrong size on UInterchangeSceneImportAssetFactoryNode");
...
{
public:
	uint8                                         Pad_2D0[0xC8];                                     // 0x02D0(0x00C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInterchangeSkeletalMeshLodDataNode) == 0x000190, "Wrong size on UInterchangeSkeletalMeshLodDataNode");
...
static_assert(sizeof(UInterchangeStaticMeshFactoryNode) == 0x0003B8, "Wrong size on UInterchangeStaticMeshFactoryNode");
