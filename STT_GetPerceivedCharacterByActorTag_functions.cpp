...
#include "STT_GetPerceivedCharacterByActorTag_classes.hpp"
#include "STT_GetPerceivedCharacterByActorTag_parameters.hpp"
...
void USTT_GetPerceivedCharacterByActorTag_C::FindCharacterWithActorTag()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("STT_GetPerceivedCharacterByActorTag_C", "FindCharacterWithActorTag");
