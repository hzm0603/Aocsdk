...
static_assert(sizeof(UAudioAnalyzerAssetBase) == 0x000048, "Wrong size on UAudioAnalyzerAssetBase");
...
static_assert(sizeof(UAudioAnalyzerSettings) == 0x000048, "Wrong size on UAudioAnalyzerSettings");
...
{
public:
	class UAudioBus*                              AudioBus;                                          // 0x0048(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x8];                                       // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UAudioAnalyzerSubsystem*                AudioAnalyzerSubsystem;                            // 0x0058(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAudioAnalyzer) == 0x0000B0, "Wrong size on UAudioAnalyzer");
static_assert(offsetof(UAudioAnalyzer, AudioBus) == 0x000048, "Member 'UAudioAnalyzer::AudioBus' has a wrong offset!");
static_assert(offsetof(UAudioAnalyzer, AudioAnalyzerSubsystem) == 0x000058, "Member 'UAudioAnalyzer::AudioAnalyzerSubsystem' has a wrong offset!");
...
static_assert(sizeof(UAudioAnalyzerNRTSettings) == 0x000048, "Wrong size on UAudioAnalyzerNRTSettings");
...
{
public:
	class USoundWave*                             Sound;                                             // 0x0048(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DurationInSeconds;                                 // 0x0050(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAudioAnalyzerNRT) == 0x000098, "Wrong size on UAudioAnalyzerNRT");
static_assert(offsetof(UAudioAnalyzerNRT, Sound) == 0x000048, "Member 'UAudioAnalyzerNRT::Sound' has a wrong offset!");
static_assert(offsetof(UAudioAnalyzerNRT, DurationInSeconds) == 0x000050, "Member 'UAudioAnalyzerNRT::DurationInSeconds' has a wrong offset!");
...
{
public:
	TArray<class UAudioAnalyzer*>                 AudioAnalyzers;                                    // 0x0050(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAudioAnalyzerSubsystem) == 0x000070, "Wrong size on UAudioAnalyzerSubsystem");
static_assert(offsetof(UAudioAnalyzerSubsystem, AudioAnalyzers) == 0x000050, "Member 'UAudioAnalyzerSubsystem::AudioAnalyzers' has a wrong offset!");
