...
{
public:
	struct FRuntimeFloatCurve                     InSliderRange;                                     // 0x0000(0x0090)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(RadialSlider_SetSliderRange) == 0x000008, "Wrong alignment on RadialSlider_SetSliderRange");
static_assert(sizeof(RadialSlider_SetSliderRange) == 0x000090, "Wrong size on RadialSlider_SetSliderRange");
