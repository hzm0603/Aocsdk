...
// Function StateTreeModule.StateTreeTaskBlueprintBase.OnTaskPooled
// (Native, Event, Protected, BlueprintEvent)

void UStateTreeTaskBlueprintBase::OnTaskPooled()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("StateTreeTaskBlueprintBase", "OnTaskPooled");
