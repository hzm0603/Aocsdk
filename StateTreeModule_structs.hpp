...
public:
	...
	struct FStateTreeExternalDataHandle           Handle;                                            // 0x0010(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FStateTreeIndex16                      BindingsBatch;                                     // 0x0010(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      DataViewIndex;                                     // 0x0012(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      InstanceIndex;                                     // 0x0014(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bInstanceIsObject : 1;                             // 0x0016(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FStateTreeNodeBase, DataViewIndex) == 0x000012, "Member 'FStateTreeNodeBase::DataViewIndex' has a wrong offset!");
static_assert(offsetof(FStateTreeNodeBase, InstanceIndex) == 0x000014, "Member 'FStateTreeNodeBase::InstanceIndex' has a wrong offset!");
...
// ScriptStruct StateTreeModule.TaskArray
// 0x0010 (0x0010 - 0x0000)
struct FTaskArray final
{
public:
	TArray<class UStateTreeTaskBlueprintBase*>    Tasks;                                             // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTaskArray) == 0x000008, "Wrong alignment on FTaskArray");
static_assert(sizeof(FTaskArray) == 0x000010, "Wrong size on FTaskArray");
static_assert(offsetof(FTaskArray, Tasks) == 0x000000, "Member 'FTaskArray::Tasks' has a wrong offset!");
...
public:
	...
	EStateTreeBindableStructSource                DataSource;                                        // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FStateTreeBindableStructDesc, DataSource) == 0x000010, "Member 'FStateTreeBindableStructDesc::DataSource' has a wrong offset!");
...
public:
	...
	struct FStateTreeIndex16                      ArrayIndex;                                        // 0x0008(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      NextIndex;                                         // 0x000A(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FStateTreeIndex16                      SourceStructIndex;                                 // 0x0020(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FStateTreeStateHandle                  State;                                             // 0x000A(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         ConditionsNum;                                     // 0x0012(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bTransitionEnabled : 1;                            // 0x0013(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
};
...
static_assert(offsetof(FCompactStateTransition, ConditionsNum) == 0x000012, "Member 'FCompactStateTransition::ConditionsNum' has a wrong offset!");
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeStateHandle                  LinkedState;                                       // 0x0008(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStateTreeStateHandle                  Parent;                                            // 0x000A(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	uint16                                        ChildrenBegin;                                     // 0x000C(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        ChildrenEnd;                                       // 0x000E(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        EnterConditionsBegin;                              // 0x0010(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        TransitionsBegin;                                  // 0x0012(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        TasksBegin;                                        // 0x0014(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      ParameterInstanceIndex;                            // 0x0016(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      ParameterDataViewIndex;                            // 0x0018(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         EnterConditionsNum;                                // 0x001A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TransitionsNum;                                    // 0x001B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TasksNum;                                          // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TaskInstanceStructNum;                             // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TaskInstanceObjectNum;                             // 0x001E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EStateTreeStateType                           Type;                                              // 0x001F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EStateTreeStateSelectionBehavior              SelectionBehavior;                                 // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHasTransitionTasks : 1;                           // 0x0021(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnabled : 1;                                      // 0x0021(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FCompactStateTreeState) == 0x000024, "Wrong size on FCompactStateTreeState");
...
static_assert(offsetof(FCompactStateTreeState, Parent) == 0x00000A, "Member 'FCompactStateTreeState::Parent' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenBegin) == 0x00000C, "Member 'FCompactStateTreeState::ChildrenBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenEnd) == 0x00000E, "Member 'FCompactStateTreeState::ChildrenEnd' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsBegin) == 0x000010, "Member 'FCompactStateTreeState::EnterConditionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsBegin) == 0x000012, "Member 'FCompactStateTreeState::TransitionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksBegin) == 0x000014, "Member 'FCompactStateTreeState::TasksBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterInstanceIndex) == 0x000016, "Member 'FCompactStateTreeState::ParameterInstanceIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterDataViewIndex) == 0x000018, "Member 'FCompactStateTreeState::ParameterDataViewIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsNum) == 0x00001A, "Member 'FCompactStateTreeState::EnterConditionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsNum) == 0x00001B, "Member 'FCompactStateTreeState::TransitionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksNum) == 0x00001C, "Member 'FCompactStateTreeState::TasksNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TaskInstanceStructNum) == 0x00001D, "Member 'FCompactStateTreeState::TaskInstanceStructNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TaskInstanceObjectNum) == 0x00001E, "Member 'FCompactStateTreeState::TaskInstanceObjectNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Type) == 0x00001F, "Member 'FCompactStateTreeState::Type' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, SelectionBehavior) == 0x000020, "Member 'FCompactStateTreeState::SelectionBehavior' has a wrong offset!");
