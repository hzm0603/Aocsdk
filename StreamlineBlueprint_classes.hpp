...
static_assert(sizeof(UStreamlineLibrary) == 0x000048, "Wrong size on UStreamlineLibrary");
...
static_assert(sizeof(UStreamlineLibraryDLSSG) == 0x000048, "Wrong size on UStreamlineLibraryDLSSG");
...
static_assert(sizeof(UStreamlineLibraryReflex) == 0x000048, "Wrong size on UStreamlineLibraryReflex");
