...
{
public:
	class USlateWidgetStyleContainerBase*         CustomStyle;                                       // 0x0048(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USlateWidgetStyleAsset) == 0x000050, "Wrong size on USlateWidgetStyleAsset");
static_assert(offsetof(USlateWidgetStyleAsset, CustomStyle) == 0x000048, "Member 'USlateWidgetStyleAsset::CustomStyle' has a wrong offset!");
...
static_assert(sizeof(USlateTypes) == 0x000048, "Wrong size on USlateTypes");
...
{
public:
	struct FGuid                                  CurrentThemeId;                                    // 0x0048(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStyleColorList                        ActiveColors;                                      // 0x0058(0x0988)(Edit, Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USlateThemeManager) == 0x0009E0, "Wrong size on USlateThemeManager");
static_assert(offsetof(USlateThemeManager, CurrentThemeId) == 0x000048, "Member 'USlateThemeManager::CurrentThemeId' has a wrong offset!");
static_assert(offsetof(USlateThemeManager, ActiveColors) == 0x000058, "Member 'USlateThemeManager::ActiveColors' has a wrong offset!");
