...
static_assert(sizeof(UObject) == 0x000048, "Wrong size on UObject");
...
static_assert(sizeof(UTextBuffer) == 0x000070, "Wrong size on UTextBuffer");
...
static_assert(sizeof(UGCObjectReferencer) == 0x000058, "Wrong size on UGCObjectReferencer");
...
{
public:
	class UField*                                 Next;                                              // 0x0048(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UField) == 0x000050, "Wrong size on UField");
static_assert(offsetof(UField, Next) == 0x000048, "Member 'UField::Next' has a wrong offset!");
...
public:
	...
	class UStruct*                                Super;                                             // 0x0060(0x0008)(NOT AUTO-GENERATED PROPERTY)
	class UField*                                 Children;                                          // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	class FField*                                 ChildProperties;                                   // 0x0070(0x0008)(NOT AUTO-GENERATED PROPERTY)
	int32                                         Size;                                              // 0x0078(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         MinAlignemnt;                                      // 0x007C(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UStruct) == 0x0000D0, "Wrong size on UStruct");
static_assert(offsetof(UStruct, Super) == 0x000060, "Member 'UStruct::Super' has a wrong offset!");
static_assert(offsetof(UStruct, Children) == 0x000068, "Member 'UStruct::Children' has a wrong offset!");
static_assert(offsetof(UStruct, ChildProperties) == 0x000070, "Member 'UStruct::ChildProperties' has a wrong offset!");
static_assert(offsetof(UStruct, Size) == 0x000078, "Member 'UStruct::Size' has a wrong offset!");
static_assert(offsetof(UStruct, MinAlignemnt) == 0x00007C, "Member 'UStruct::MinAlignemnt' has a wrong offset!");
...
static_assert(sizeof(UScriptStruct) == 0x0000E0, "Wrong size on UScriptStruct");
...
static_assert(sizeof(UPackage) == 0x0000B0, "Wrong size on UPackage");
...
public:
	...
	uint8                                         Pad_100[0xD0];                                     // 0x0100(0x00D0)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                DefaultObject;                                     // 0x01D0(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UClass) == 0x0002C0, "Wrong size on UClass");
static_assert(offsetof(UClass, CastFlags) == 0x0000F8, "Member 'UClass::CastFlags' has a wrong offset!");
static_assert(offsetof(UClass, DefaultObject) == 0x0001D0, "Member 'UClass::DefaultObject' has a wrong offset!");
...
static_assert(sizeof(UFunction) == 0x000100, "Wrong size on UFunction");
static_assert(offsetof(UFunction, FunctionFlags) == 0x0000D0, "Member 'UFunction::FunctionFlags' has a wrong offset!");
static_assert(offsetof(UFunction, ExecFunction) == 0x0000F8, "Member 'UFunction::ExecFunction' has a wrong offset!");
...
static_assert(sizeof(UDelegateFunction) == 0x000100, "Wrong size on UDelegateFunction");
...
static_assert(sizeof(USparseDelegateFunction) == 0x000110, "Wrong size on USparseDelegateFunction");
...
static_assert(sizeof(UDynamicClass) == 0x000340, "Wrong size on UDynamicClass");
...
static_assert(sizeof(UPackageMap) == 0x000100, "Wrong size on UPackageMap");
...
public:
	uint8                                         Pad_50[0x10];                                      // 0x0050(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class TArray<class TPair<class FName, int64>> Names;                                             // 0x0060(0x0010)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UEnum) == 0x000088, "Wrong size on UEnum");
static_assert(offsetof(UEnum, Names) == 0x000060, "Member 'UEnum::Names' has a wrong offset!");
...
static_assert(sizeof(ULinkerPlaceholderClass) == 0x000480, "Wrong size on ULinkerPlaceholderClass");
...
static_assert(sizeof(ULinkerPlaceholderExportObject) == 0x000118, "Wrong size on ULinkerPlaceholderExportObject");
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x0002C0, "Wrong size on ULinkerPlaceholderFunction");
...
static_assert(sizeof(UMetaData) == 0x0000E8, "Wrong size on UMetaData");
...
static_assert(sizeof(UObjectRedirector) == 0x000050, "Wrong size on UObjectRedirector");
...
static_assert(sizeof(UMulticastInlineDelegateProperty) == 0x000098, "Wrong size on UMulticastInlineDelegateProperty");
...
static_assert(sizeof(UMulticastSparseDelegateProperty) == 0x000098, "Wrong size on UMulticastSparseDelegateProperty");
...
static_assert(sizeof(USetProperty) == 0x0000B0, "Wrong size on USetProperty");
...
static_assert(sizeof(USoftObjectProperty) == 0x000098, "Wrong size on USoftObjectProperty");
...
static_assert(sizeof(USoftClassProperty) == 0x0000A0, "Wrong size on USoftClassProperty");
...
static_assert(sizeof(UPropertyWrapper) == 0x000050, "Wrong size on UPropertyWrapper");
...
static_assert(sizeof(UMulticastDelegatePropertyWrapper) == 0x000050, "Wrong size on UMulticastDelegatePropertyWrapper");
...
static_assert(sizeof(UMulticastInlineDelegatePropertyWrapper) == 0x000050, "Wrong size on UMulticastInlineDelegatePropertyWrapper");
