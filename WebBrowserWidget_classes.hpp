...
static_assert(sizeof(UWebBrowser) == 0x000208, "Wrong size on UWebBrowser");
static_assert(offsetof(UWebBrowser, OnUrlChanged) == 0x0001B0, "Member 'UWebBrowser::OnUrlChanged' has a wrong offset!");
static_assert(offsetof(UWebBrowser, OnBeforePopup) == 0x0001C0, "Member 'UWebBrowser::OnBeforePopup' has a wrong offset!");
static_assert(offsetof(UWebBrowser, OnConsoleMessage) == 0x0001D0, "Member 'UWebBrowser::OnConsoleMessage' has a wrong offset!");
static_assert(offsetof(UWebBrowser, InitialURL) == 0x0001E0, "Member 'UWebBrowser::InitialURL' has a wrong offset!");
static_assert(offsetof(UWebBrowser, bSupportsTransparency) == 0x0001F0, "Member 'UWebBrowser::bSupportsTransparency' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UMaterial>               DefaultMaterial;                                   // 0x0048(0x0028)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWebBrowserAssetManager) == 0x000098, "Wrong size on UWebBrowserAssetManager");
static_assert(offsetof(UWebBrowserAssetManager, DefaultMaterial) == 0x000048, "Member 'UWebBrowserAssetManager::DefaultMaterial' has a wrong offset!");
