...
static_assert(sizeof(UPropertyBagMissingObject) == 0x000048, "Wrong size on UPropertyBagMissingObject");
...
static_assert(sizeof(UPropertyBag) == 0x0000F8, "Wrong size on UPropertyBag");
static_assert(offsetof(UPropertyBag, PropertyDescs) == 0x0000E0, "Member 'UPropertyBag::PropertyDescs' has a wrong offset!");
