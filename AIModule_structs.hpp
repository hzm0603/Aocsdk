...
// Enum AIModule.EBTDecoratorEvaluationScheme
// NumValues: 0x0004
enum class EBTDecoratorEvaluationScheme : uint8
{
	NotProcessing                            = 0,
	Processing                               = 1,
	Both                                     = 2,
	EBTDecoratorEvaluationScheme_MAX         = 3,
};

// Enum AIModule.EBTDecoratorTimings
// NumValues: 0x0005
enum class EBTDecoratorTimings : uint8
{
	Started                                  = 0,
	Aborted                                  = 1,
	Finished                                 = 2,
	Complete                                 = 3,
	EBTDecoratorTimings_MAX                  = 4,
};

// Enum AIModule.EIntrepidScoringDecoratorType
// NumValues: 0x0004
enum class EIntrepidScoringDecoratorType : uint8
{
	Highest                                  = 0,
	Product                                  = 1,
	cCount                                   = 2,
	EIntrepidScoringDecoratorType_MAX        = 3,
};
