...
// Package: Bandit_Captain_Capn_Knuckles
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Bandit_Captain_Capn_Knuckles_C">();
	}
	static class ABandit_Captain_Capn_Knuckles_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABandit_Captain_Capn_Knuckles_C>();
	}
};
