...
{
public:
	class FText                                   ToolName;                                          // 0x00C0(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   ToolLongName;                                      // 0x00D8(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   ToolCategory;                                      // 0x00F0(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   ToolTooltip;                                       // 0x0108(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FString                                 CustomIconPath;                                    // 0x0120(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowToolInEditor;                                 // 0x0130(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EScriptableToolShutdownType                   ToolShutdownType;                                  // 0x0131(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_132[0x2];                                      // 0x0132(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UWorld>                  TargetWorld;                                       // 0x0134(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NonTransactional, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UScriptableInteractiveTool) == 0x000270, "Wrong size on UScriptableInteractiveTool");
static_assert(offsetof(UScriptableInteractiveTool, ToolName) == 0x0000C0, "Member 'UScriptableInteractiveTool::ToolName' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, ToolLongName) == 0x0000D8, "Member 'UScriptableInteractiveTool::ToolLongName' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, ToolCategory) == 0x0000F0, "Member 'UScriptableInteractiveTool::ToolCategory' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, ToolTooltip) == 0x000108, "Member 'UScriptableInteractiveTool::ToolTooltip' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, CustomIconPath) == 0x000120, "Member 'UScriptableInteractiveTool::CustomIconPath' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, bShowToolInEditor) == 0x000130, "Member 'UScriptableInteractiveTool::bShowToolInEditor' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, ToolShutdownType) == 0x000131, "Member 'UScriptableInteractiveTool::ToolShutdownType' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, TargetWorld) == 0x000134, "Member 'UScriptableInteractiveTool::TargetWorld' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, RenderHelper) == 0x000140, "Member 'UScriptableInteractiveTool::RenderHelper' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, DrawHUDHelper) == 0x000148, "Member 'UScriptableInteractiveTool::DrawHUDHelper' has a wrong offset!");
static_assert(offsetof(UScriptableInteractiveTool, Gizmos) == 0x000220, "Member 'UScriptableInteractiveTool::Gizmos' has a wrong offset!");
...
public:
	...
	bool                                          bWantMouseHover;                                   // 0x0280(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateModifiersDuringDrag;                        // 0x0281(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_282[0x6];                                      // 0x0282(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UClickDragInputBehavior*                ClickDragBehavior;                                 // 0x0288(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_290[0x8];                                      // 0x0290(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMouseHoverBehavior*                    MouseHoverBehavior;                                // 0x0298(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScriptableClickDragTool) == 0x0002A8, "Wrong size on UScriptableClickDragTool");
static_assert(offsetof(UScriptableClickDragTool, bWantMouseHover) == 0x000280, "Member 'UScriptableClickDragTool::bWantMouseHover' has a wrong offset!");
static_assert(offsetof(UScriptableClickDragTool, bUpdateModifiersDuringDrag) == 0x000281, "Member 'UScriptableClickDragTool::bUpdateModifiersDuringDrag' has a wrong offset!");
static_assert(offsetof(UScriptableClickDragTool, ClickDragBehavior) == 0x000288, "Member 'UScriptableClickDragTool::ClickDragBehavior' has a wrong offset!");
static_assert(offsetof(UScriptableClickDragTool, MouseHoverBehavior) == 0x000298, "Member 'UScriptableClickDragTool::MouseHoverBehavior' has a wrong offset!");
...
static_assert(sizeof(UScriptableTool_RenderAPI) == 0x000050, "Wrong size on UScriptableTool_RenderAPI");
...
static_assert(sizeof(UScriptableTool_HUDAPI) == 0x000058, "Wrong size on UScriptableTool_HUDAPI");
...
static_assert(sizeof(UScriptableInteractiveToolPropertySet) == 0x0000D0, "Wrong size on UScriptableInteractiveToolPropertySet");
...
static_assert(sizeof(UScriptableToolsUtilityLibrary) == 0x000048, "Wrong size on UScriptableToolsUtilityLibrary");
...
public:
	...
	class USingleClickInputBehavior*              SingleClickBehavior;                               // 0x0288(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMouseHoverBehavior*                    MouseHoverBehavior;                                // 0x0290(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScriptableSingleClickTool) == 0x0002A0, "Wrong size on UScriptableSingleClickTool");
static_assert(offsetof(UScriptableSingleClickTool, bWantMouseHover) == 0x000280, "Member 'UScriptableSingleClickTool::bWantMouseHover' has a wrong offset!");
static_assert(offsetof(UScriptableSingleClickTool, SingleClickBehavior) == 0x000288, "Member 'UScriptableSingleClickTool::SingleClickBehavior' has a wrong offset!");
static_assert(offsetof(UScriptableSingleClickTool, MouseHoverBehavior) == 0x000290, "Member 'UScriptableSingleClickTool::MouseHoverBehavior' has a wrong offset!");
...
static_assert(sizeof(UBaseScriptableToolBuilder) == 0x000050, "Wrong size on UBaseScriptableToolBuilder");
