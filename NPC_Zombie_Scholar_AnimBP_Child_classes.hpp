...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"NPC_Zombie_Scholar_AnimBP_Child_C">();
	}
	static class UNPC_Zombie_Scholar_AnimBP_Child_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UNPC_Zombie_Scholar_AnimBP_Child_C>();
	}
};
