...
public:
	...
	class UMovieSceneSection*                     SectionToKey;                                      // 0x00C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneMaterialTrack) == 0x0000D0, "Wrong size on UMovieSceneMaterialTrack");
...
static_assert(offsetof(UMovieSceneMaterialTrack, SectionToKey) == 0x0000C8, "Member 'UMovieSceneMaterialTrack::SectionToKey' has a wrong offset!");
...
static_assert(sizeof(IMovieSceneTransformOrigin) == 0x000048, "Wrong size on IMovieSceneTransformOrigin");
...
static_assert(sizeof(IMovieSceneConsoleVariableTrackInterface) == 0x000048, "Wrong size on IMovieSceneConsoleVariableTrackInterface");
...
{
public:
	float                                         FloatProperty;                                     // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneDecomposerTestObject) == 0x000050, "Wrong size on UMovieSceneDecomposerTestObject");
static_assert(offsetof(UMovieSceneDecomposerTestObject, FloatProperty) == 0x000048, "Member 'UMovieSceneDecomposerTestObject::FloatProperty' has a wrong offset!");
...
static_assert(sizeof(UFloatChannelEvaluatorSystem) == 0x000060, "Wrong size on UFloatChannelEvaluatorSystem");
...
public:
	...
	TArray<class UObject*>                        BoundObjects;                                      // 0x0090(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<struct FGuid>                          BindingGuids;                                      // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneTestSequence) == 0x0000B0, "Wrong size on UMovieSceneTestSequence");
static_assert(offsetof(UMovieSceneTestSequence, MovieScene) == 0x000088, "Member 'UMovieSceneTestSequence::MovieScene' has a wrong offset!");
static_assert(offsetof(UMovieSceneTestSequence, BoundObjects) == 0x000090, "Member 'UMovieSceneTestSequence::BoundObjects' has a wrong offset!");
static_assert(offsetof(UMovieSceneTestSequence, BindingGuids) == 0x0000A0, "Member 'UMovieSceneTestSequence::BindingGuids' has a wrong offset!");
...
{
public:
	struct FMovieSceneDoublePerlinNoiseChannel    PerlinNoiseChannel;                                // 0x0078(0x0068)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneDoublePerlinNoiseChannelContainer, PerlinNoiseChannel) == 0x000078, "Member 'UMovieSceneDoublePerlinNoiseChannelContainer::PerlinNoiseChannel' has a wrong offset!");
...
public:
	...
	class UMovieScenePropertyInstantiatorSystem*  InstantiatorSystem;                                // 0x0068(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieScenePropertySystem) == 0x000078, "Wrong size on UMovieScenePropertySystem");
static_assert(offsetof(UMovieScenePropertySystem, InstantiatorSystem) == 0x000068, "Member 'UMovieScenePropertySystem::InstantiatorSystem' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneBoolPropertySystem) == 0x000078, "Wrong size on UMovieSceneBoolPropertySystem");
...
{
public:
	struct FMovieSceneFloatPerlinNoiseChannel     PerlinNoiseChannel;                                // 0x0078(0x0068)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneFloatPerlinNoiseChannelContainer, PerlinNoiseChannel) == 0x000078, "Member 'UMovieSceneFloatPerlinNoiseChannelContainer::PerlinNoiseChannel' has a wrong offset!");
...
{
public:
	uint8                                         Pad_60[0x1B0];                                     // 0x0060(0x01B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneInterrogatedPropertyInstantiatorSystem) == 0x000210, "Wrong size on UMovieSceneInterrogatedPropertyInstantiatorSystem");
...
static_assert(sizeof(UMovieScene3DTransformPropertySystem) == 0x000078, "Wrong size on UMovieScene3DTransformPropertySystem");
...
static_assert(sizeof(UMovieSceneCameraShakeEvaluator) == 0x000048, "Wrong size on UMovieSceneCameraShakeEvaluator");
...
public:
	...
	struct FMovieScenePropertyBinding             PropertyBinding;                                   // 0x00C0(0x0014)(NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieScenePropertyTrack) == 0x0000E8, "Wrong size on UMovieScenePropertyTrack");
static_assert(offsetof(UMovieScenePropertyTrack, SectionToKey) == 0x0000B8, "Member 'UMovieScenePropertyTrack::SectionToKey' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, PropertyBinding) == 0x0000C0, "Member 'UMovieScenePropertyTrack::PropertyBinding' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, Sections) == 0x0000D8, "Member 'UMovieScenePropertyTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatTrack) == 0x0000E8, "Wrong size on UMovieSceneFloatTrack");
...
static_assert(sizeof(UMovieScene3DAttachSection) == 0x000158, "Wrong size on UMovieScene3DAttachSection");
static_assert(offsetof(UMovieScene3DAttachSection, AttachSocketName) == 0x000140, "Member 'UMovieScene3DAttachSection::AttachSocketName' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachComponentName) == 0x000148, "Member 'UMovieScene3DAttachSection::AttachComponentName' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentLocationRule) == 0x000150, "Member 'UMovieScene3DAttachSection::AttachmentLocationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentRotationRule) == 0x000151, "Member 'UMovieScene3DAttachSection::AttachmentRotationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentScaleRule) == 0x000152, "Member 'UMovieScene3DAttachSection::AttachmentScaleRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentLocationRule) == 0x000153, "Member 'UMovieScene3DAttachSection::DetachmentLocationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentRotationRule) == 0x000154, "Member 'UMovieScene3DAttachSection::DetachmentRotationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentScaleRule) == 0x000155, "Member 'UMovieScene3DAttachSection::DetachmentScaleRule' has a wrong offset!");
...
{
public:
	struct FMovieSceneFloatChannel                TimingCurve;                                       // 0x0138(0x0110)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneBytePropertySystem) == 0x000078, "Wrong size on UMovieSceneBytePropertySystem");
...
{
public:
	TArray<struct FConstraintAndActiveChannel>    ConstraintsChannels;                               // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieScene3DTransformSectionConstraints) == 0x000058, "Wrong size on UMovieScene3DTransformSectionConstraints");
static_assert(offsetof(UMovieScene3DTransformSectionConstraints, ConstraintsChannels) == 0x000048, "Member 'UMovieScene3DTransformSectionConstraints::ConstraintsChannels' has a wrong offset!");

// Class MovieSceneTracks.MovieScene3DTransformSection
// 0x0B48 (0x0C58 - 0x0110)
...
public:
	...
	struct FMovieSceneTransformMask               TransformMask;                                     // 0x0150(0x0004)(NoDestructor, NativeAccessSpecifierPrivate)
	...
	struct FMovieSceneDoubleChannel               Scale[0x3];                                        // 0x07E8(0x0118)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                ManualWeight;                                      // 0x0B30(0x0110)(NativeAccessSpecifierPrivate)
	class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                                  // 0x0C40(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieScene3DTransformSectionConstraints* Constraints;                                       // 0x0C48(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bUseQuaternionInterpolation;                       // 0x0C50(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_C51[0x7];                                      // 0x0C51(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieScene3DTransformSection) == 0x000C58, "Wrong size on UMovieScene3DTransformSection");
static_assert(offsetof(UMovieScene3DTransformSection, TransformMask) == 0x000150, "Member 'UMovieScene3DTransformSection::TransformMask' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Translation) == 0x000158, "Member 'UMovieScene3DTransformSection::Translation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Rotation) == 0x0004A0, "Member 'UMovieScene3DTransformSection::Rotation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Scale) == 0x0007E8, "Member 'UMovieScene3DTransformSection::Scale' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, ManualWeight) == 0x000B30, "Member 'UMovieScene3DTransformSection::ManualWeight' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, OverrideRegistry) == 0x000C40, "Member 'UMovieScene3DTransformSection::OverrideRegistry' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Constraints) == 0x000C48, "Member 'UMovieScene3DTransformSection::Constraints' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, bUseQuaternionInterpolation) == 0x000C50, "Member 'UMovieScene3DTransformSection::bUseQuaternionInterpolation' has a wrong offset!");
...
{
public:
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x0110(0x0120)(NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorReferenceData) == 0x000110, "Member 'UMovieSceneActorReferenceSection::ActorReferenceData' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEventSectionBase) == 0x000110, "Wrong size on UMovieSceneEventSectionBase");
...
public:
	...
	struct FMovieSceneEventChannel                EventChannel;                                      // 0x0118(0x00F8)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneEventTriggerSection, EventChannel) == 0x000118, "Member 'UMovieSceneEventTriggerSection::EventChannel' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSkeletalAnimationSystem) == 0x000100, "Wrong size on UMovieSceneSkeletalAnimationSystem");

// Class MovieSceneTracks.MovieSceneAudioSection
// 0x0538 (0x0648 - 0x0110)
...
public:
	...
	struct FFrameNumber                           StartFrameOffset;                                  // 0x0120(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x0618(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TMulticastInlineDelegate<void(class USoundWave* PlayingSoundWave, float PlaybackPercent)> OnAudioPlaybackPercent;                            // 0x0638(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneComponentMaterialSystem) == 0x0001C0, "Wrong size on UMovieSceneComponentMaterialSystem");
...
static_assert(sizeof(UMovieSceneBaseCacheSection) == 0x000118, "Wrong size on UMovieSceneBaseCacheSection");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneByteChannel                 ByteCurve;                                         // 0x0118(0x0108)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneCameraCutSection) == 0x0001C0, "Wrong size on UMovieSceneCameraCutSection");
static_assert(offsetof(UMovieSceneCameraCutSection, bLockPreviousCamera) == 0x000118, "Member 'UMovieSceneCameraCutSection::bLockPreviousCamera' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraGuid) == 0x00011C, "Member 'UMovieSceneCameraCutSection::CameraGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraBindingID) == 0x00012C, "Member 'UMovieSceneCameraCutSection::CameraBindingID' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, InitialCameraCutTransform) == 0x000150, "Member 'UMovieSceneCameraCutSection::InitialCameraCutTransform' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, bHasInitialCameraCutTransform) == 0x0001B0, "Member 'UMovieSceneCameraCutSection::bHasInitialCameraCutTransform' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneLevelVisibilitySection, Visibility) == 0x000118, "Member 'UMovieSceneLevelVisibilitySection::Visibility' has a wrong offset!");
static_assert(offsetof(UMovieSceneLevelVisibilitySection, LevelNames) == 0x000120, "Member 'UMovieSceneLevelVisibilitySection::LevelNames' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatVectorPropertySystem) == 0x000078, "Wrong size on UMovieSceneFloatVectorPropertySystem");
...
public:
	...
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x00C0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneParticleParameterTrack, Sections) == 0x0000C0, "Member 'UMovieSceneParticleParameterTrack::Sections' has a wrong offset!");
...
{
public:
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x0110(0x0108)(NativeAccessSpecifierPublic)
...
public:
	...
	class UWeightAndEasingEvaluatorSystem*        EvaluatorSystem;                                   // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneHierarchicalEasingInstantiatorSystem) == 0x0000F8, "Wrong size on UMovieSceneHierarchicalEasingInstantiatorSystem");
static_assert(offsetof(UMovieSceneHierarchicalEasingInstantiatorSystem, EvaluatorSystem) == 0x0000E8, "Member 'UMovieSceneHierarchicalEasingInstantiatorSystem::EvaluatorSystem' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                RedCurve;                                          // 0x0118(0x0110)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                GreenCurve;                                        // 0x0228(0x0110)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                BlueCurve;                                         // 0x0338(0x0110)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                AlphaCurve;                                        // 0x0448(0x0110)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneColorSection) == 0x000558, "Wrong size on UMovieSceneColorSection");
...
static_assert(offsetof(UMovieSceneColorSection, BlueCurve) == 0x000338, "Member 'UMovieSceneColorSection::BlueCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, AlphaCurve) == 0x000448, "Member 'UMovieSceneColorSection::AlphaCurve' has a wrong offset!");
...
static_assert(sizeof(IMovieSceneConstrainedSection) == 0x000048, "Wrong size on IMovieSceneConstrainedSection");
...
static_assert(sizeof(UMovieSceneCVarSection) == 0x000178, "Wrong size on UMovieSceneCVarSection");
static_assert(offsetof(UMovieSceneCVarSection, ConsoleVariableCollections) == 0x000118, "Member 'UMovieSceneCVarSection::ConsoleVariableCollections' has a wrong offset!");
static_assert(offsetof(UMovieSceneCVarSection, ConsoleVariables) == 0x000128, "Member 'UMovieSceneCVarSection::ConsoleVariables' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FActorDataLayer>                DataLayers;                                        // 0x0118(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UDataLayerAsset*>                DataLayerAssets;                                   // 0x0128(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	EDataLayerRuntimeState                        DesiredState;                                      // 0x0138(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EDataLayerRuntimeState                        PrerollState;                                      // 0x0139(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bFlushOnUnload;                                    // 0x013A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneDataLayerSection) == 0x000140, "Wrong size on UMovieSceneDataLayerSection");
static_assert(offsetof(UMovieSceneDataLayerSection, DataLayers) == 0x000118, "Member 'UMovieSceneDataLayerSection::DataLayers' has a wrong offset!");
static_assert(offsetof(UMovieSceneDataLayerSection, DataLayerAssets) == 0x000128, "Member 'UMovieSceneDataLayerSection::DataLayerAssets' has a wrong offset!");
static_assert(offsetof(UMovieSceneDataLayerSection, DesiredState) == 0x000138, "Member 'UMovieSceneDataLayerSection::DesiredState' has a wrong offset!");
static_assert(offsetof(UMovieSceneDataLayerSection, PrerollState) == 0x000139, "Member 'UMovieSceneDataLayerSection::PrerollState' has a wrong offset!");
static_assert(offsetof(UMovieSceneDataLayerSection, bFlushOnUnload) == 0x00013A, "Member 'UMovieSceneDataLayerSection::bFlushOnUnload' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneStringChannel               StringCurve;                                       // 0x0118(0x0110)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCVarTrackInstance) == 0x0000C0, "Wrong size on UMovieSceneCVarTrackInstance");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneDoubleChannel               DoubleCurve;                                       // 0x0118(0x0118)(Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMovieSceneDoubleSection, DoubleCurve) == 0x000118, "Member 'UMovieSceneDoubleSection::DoubleCurve' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneByteChannel                 EnumCurve;                                         // 0x0118(0x0108)(NativeAccessSpecifierPublic)
...
{
public:
	int32                                         NumChannelsUsed;                                   // 0x00E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneDoubleVectorTrack) == 0x0000F0, "Wrong size on UMovieSceneDoubleVectorTrack");
static_assert(offsetof(UMovieSceneDoubleVectorTrack, NumChannelsUsed) == 0x0000E8, "Member 'UMovieSceneDoubleVectorTrack::NumChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEventRepeaterSection) == 0x000140, "Wrong size on UMovieSceneEventRepeaterSection");
static_assert(offsetof(UMovieSceneEventRepeaterSection, Event) == 0x000118, "Member 'UMovieSceneEventRepeaterSection::Event' has a wrong offset!");
...
public:
	...
	struct FMovieSceneEventSectionData            EventData;                                         // 0x0188(0x00F8)(NativeAccessSpecifierPrivate)
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x0118(0x0110)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneFadeSection, FloatCurve) == 0x000118, "Member 'UMovieSceneFadeSection::FloatCurve' has a wrong offset!");
...
public:
	...
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x0120(0x0110)(Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMovieSceneFloatSection, FloatCurve) == 0x000120, "Member 'UMovieSceneFloatSection::FloatCurve' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneIntegerChannel              IntegerCurve;                                      // 0x0118(0x0100)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(IMovieSceneParameterSectionExtender) == 0x000048, "Wrong size on IMovieSceneParameterSectionExtender");
...
static_assert(sizeof(UMovieSceneParameterSection) == 0x000178, "Wrong size on UMovieSceneParameterSection");
static_assert(offsetof(UMovieSceneParameterSection, BoolParameterNamesAndCurves) == 0x000118, "Member 'UMovieSceneParameterSection::BoolParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, ScalarParameterNamesAndCurves) == 0x000128, "Member 'UMovieSceneParameterSection::ScalarParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, Vector2DParameterNamesAndCurves) == 0x000138, "Member 'UMovieSceneParameterSection::Vector2DParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, VectorParameterNamesAndCurves) == 0x000148, "Member 'UMovieSceneParameterSection::VectorParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, ColorParameterNamesAndCurves) == 0x000158, "Member 'UMovieSceneParameterSection::ColorParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, TransformParameterNamesAndCurves) == 0x000168, "Member 'UMovieSceneParameterSection::TransformParameterNamesAndCurves' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x0118(0x0130)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieScenePrimitiveMaterialSection, MaterialChannel) == 0x000118, "Member 'UMovieScenePrimitiveMaterialSection::MaterialChannel' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x0118(0x0150)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, Params_0) == 0x000118, "Member 'UMovieSceneSkeletalAnimationSection::Params_0' has a wrong offset!");
...
// 0x0450 (0x0560 - 0x0110)
class UMovieSceneFloatVectorSection final : public UMovieSceneSection
{
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x0118(0x0110)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneFloatVectorSection) == 0x000560, "Wrong size on UMovieSceneFloatVectorSection");
static_assert(offsetof(UMovieSceneFloatVectorSection, Curves) == 0x000118, "Member 'UMovieSceneFloatVectorSection::Curves' has a wrong offset!");
static_assert(offsetof(UMovieSceneFloatVectorSection, ChannelsUsed) == 0x000558, "Member 'UMovieSceneFloatVectorSection::ChannelsUsed' has a wrong offset!");
...
public:
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneDoubleChannel               Curves[0x4];                                       // 0x0118(0x0118)(NativeAccessSpecifierPrivate)
	int32                                         ChannelsUsed;                                      // 0x0578(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneDoubleVectorSection) == 0x000580, "Wrong size on UMovieSceneDoubleVectorSection");
static_assert(offsetof(UMovieSceneDoubleVectorSection, Curves) == 0x000118, "Member 'UMovieSceneDoubleVectorSection::Curves' has a wrong offset!");
static_assert(offsetof(UMovieSceneDoubleVectorSection, ChannelsUsed) == 0x000578, "Member 'UMovieSceneDoubleVectorSection::ChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UBoolChannelEvaluatorSystem) == 0x000060, "Wrong size on UBoolChannelEvaluatorSystem");
...
static_assert(sizeof(UByteChannelEvaluatorSystem) == 0x000060, "Wrong size on UByteChannelEvaluatorSystem");
...
static_assert(sizeof(UDoubleChannelEvaluatorSystem) == 0x000060, "Wrong size on UDoubleChannelEvaluatorSystem");
...
static_assert(sizeof(UDoublePerlinNoiseChannelEvaluatorSystem) == 0x000060, "Wrong size on UDoublePerlinNoiseChannelEvaluatorSystem");
...
static_assert(sizeof(UFloatPerlinNoiseChannelEvaluatorSystem) == 0x000060, "Wrong size on UFloatPerlinNoiseChannelEvaluatorSystem");
...
static_assert(sizeof(UIntegerChannelEvaluatorSystem) == 0x000060, "Wrong size on UIntegerChannelEvaluatorSystem");
...
static_assert(sizeof(UMovieSceneAudioSystem) == 0x000110, "Wrong size on UMovieSceneAudioSystem");
...
static_assert(sizeof(UMovieSceneBaseValueEvaluatorSystem) == 0x000060, "Wrong size on UMovieSceneBaseValueEvaluatorSystem");
...
static_assert(sizeof(UMovieSceneColorPropertySystem) == 0x000078, "Wrong size on UMovieSceneColorPropertySystem");
...
static_assert(sizeof(UMovieSceneComponentAttachmentInvalidatorSystem) == 0x000060, "Wrong size on UMovieSceneComponentAttachmentInvalidatorSystem");
...
{
public:
	uint8                                         Pad_60[0x190];                                     // 0x0060(0x0190)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneComponentAttachmentSystem) == 0x0001F0, "Wrong size on UMovieSceneComponentAttachmentSystem");
...
{
public:
	uint8                                         Pad_60[0x1F0];                                     // 0x0060(0x01F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneComponentTransformSystem) == 0x000078, "Wrong size on UMovieSceneComponentTransformSystem");
...
static_assert(sizeof(UMovieSceneConstraintSystem) == 0x000070, "Wrong size on UMovieSceneConstraintSystem");
...
static_assert(sizeof(UMovieSceneDeferredComponentMovementSystem) == 0x000078, "Wrong size on UMovieSceneDeferredComponentMovementSystem");
...
static_assert(sizeof(UMovieSceneDoublePropertySystem) == 0x000078, "Wrong size on UMovieSceneDoublePropertySystem");
...
static_assert(sizeof(UMovieSceneEnumPropertySystem) == 0x000078, "Wrong size on UMovieSceneEnumPropertySystem");
...
static_assert(sizeof(UMovieSceneEulerTransformPropertySystem) == 0x000078, "Wrong size on UMovieSceneEulerTransformPropertySystem");
...
static_assert(sizeof(UMovieSceneEventSystem) == 0x0000B0, "Wrong size on UMovieSceneEventSystem");
...
static_assert(sizeof(UMovieScenePreSpawnEventSystem) == 0x0000B0, "Wrong size on UMovieScenePreSpawnEventSystem");
...
static_assert(sizeof(UMovieScenePostSpawnEventSystem) == 0x0000B0, "Wrong size on UMovieScenePostSpawnEventSystem");
...
static_assert(sizeof(UMovieScenePostEvalEventSystem) == 0x0000B0, "Wrong size on UMovieScenePostEvalEventSystem");
...
static_assert(sizeof(UMovieSceneFadeSystem) == 0x000070, "Wrong size on UMovieSceneFadeSystem");
...
static_assert(sizeof(UMovieSceneFloatPropertySystem) == 0x000078, "Wrong size on UMovieSceneFloatPropertySystem");
...
static_assert(sizeof(UMovieSceneHierarchicalBiasSystem) == 0x000060, "Wrong size on UMovieSceneHierarchicalBiasSystem");
...
static_assert(sizeof(UMovieSceneInitialValueSystem) == 0x000060, "Wrong size on UMovieSceneInitialValueSystem");
...
static_assert(sizeof(UMovieSceneIntegerPropertySystem) == 0x000078, "Wrong size on UMovieSceneIntegerPropertySystem");
...
static_assert(sizeof(UMovieSceneMaterialParameterCollectionSystem) == 0x000080, "Wrong size on UMovieSceneMaterialParameterCollectionSystem");

// Class MovieSceneTracks.MovieSceneMaterialParameterSystem
// 0x0308 (0x0368 - 0x0060)
class UMovieSceneMaterialParameterSystem final : public UMovieSceneEntitySystem
{
public:
	uint8                                         Pad_60[0x300];                                     // 0x0060(0x0300)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieScenePiecewiseDoubleBlenderSystem* DoubleBlenderSystem;                               // 0x0360(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneMaterialParameterSystem) == 0x000368, "Wrong size on UMovieSceneMaterialParameterSystem");
static_assert(offsetof(UMovieSceneMaterialParameterSystem, DoubleBlenderSystem) == 0x000360, "Member 'UMovieSceneMaterialParameterSystem::DoubleBlenderSystem' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMotionVectorSimulationSystem) == 0x0000B8, "Wrong size on UMovieSceneMotionVectorSimulationSystem");
...
static_assert(sizeof(UMovieScenePiecewiseBoolBlenderSystem) == 0x0000B0, "Wrong size on UMovieScenePiecewiseBoolBlenderSystem");
...
static_assert(sizeof(UMovieScenePiecewiseByteBlenderSystem) == 0x0000B0, "Wrong size on UMovieScenePiecewiseByteBlenderSystem");
...
static_assert(sizeof(UMovieScenePiecewiseDoubleBlenderSystem) == 0x000150, "Wrong size on UMovieScenePiecewiseDoubleBlenderSystem");
...
static_assert(sizeof(UMovieScenePiecewiseEnumBlenderSystem) == 0x0000B0, "Wrong size on UMovieScenePiecewiseEnumBlenderSystem");
...
static_assert(sizeof(UMovieScenePiecewiseIntegerBlenderSystem) == 0x0000D0, "Wrong size on UMovieScenePiecewiseIntegerBlenderSystem");
...
{
public:
	TMulticastInlineDelegate<void(const struct FTransform& PredictedTransform)> Result;                                            // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	class UMovieSceneSequencePlayer*              SequencePlayer;                                    // 0x0080(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USceneComponent*                        SceneComponent;                                    // 0x0088(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneAsyncAction_SequencePrediction) == 0x0000A0, "Wrong size on UMovieSceneAsyncAction_SequencePrediction");
static_assert(offsetof(UMovieSceneAsyncAction_SequencePrediction, Result) == 0x000050, "Member 'UMovieSceneAsyncAction_SequencePrediction::Result' has a wrong offset!");
static_assert(offsetof(UMovieSceneAsyncAction_SequencePrediction, Failure) == 0x000060, "Member 'UMovieSceneAsyncAction_SequencePrediction::Failure' has a wrong offset!");
static_assert(offsetof(UMovieSceneAsyncAction_SequencePrediction, SequencePlayer) == 0x000080, "Member 'UMovieSceneAsyncAction_SequencePrediction::SequencePlayer' has a wrong offset!");
static_assert(offsetof(UMovieSceneAsyncAction_SequencePrediction, SceneComponent) == 0x000088, "Member 'UMovieSceneAsyncAction_SequencePrediction::SceneComponent' has a wrong offset!");
...
public:
	...
	TArray<class UMovieSceneAsyncAction_SequencePrediction*> PendingPredictions;                                // 0x00F0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UMovieSceneAsyncAction_SequencePrediction*> ProcessingPredictions;                             // 0x0100(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieScenePredictionSystem) == 0x000110, "Wrong size on UMovieScenePredictionSystem");
static_assert(offsetof(UMovieScenePredictionSystem, PendingPredictions) == 0x0000F0, "Member 'UMovieScenePredictionSystem::PendingPredictions' has a wrong offset!");
static_assert(offsetof(UMovieScenePredictionSystem, ProcessingPredictions) == 0x000100, "Member 'UMovieScenePredictionSystem::ProcessingPredictions' has a wrong offset!");
...
{
public:
	uint8                                         Pad_60[0x228];                                     // 0x0060(0x0228)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieScenePropertyInstantiatorSystem) == 0x000288, "Wrong size on UMovieScenePropertyInstantiatorSystem");
...
static_assert(sizeof(UMovieSceneQuaternionBlenderSystem) == 0x0000E8, "Wrong size on UMovieSceneQuaternionBlenderSystem");
...
static_assert(sizeof(UMovieSceneQuaternionInterpolationRotationSystem) == 0x000060, "Wrong size on UMovieSceneQuaternionInterpolationRotationSystem");
...
static_assert(sizeof(UMovieSceneStringPropertySystem) == 0x000078, "Wrong size on UMovieSceneStringPropertySystem");
...
static_assert(sizeof(UMovieSceneTransformOriginInstantiatorSystem) == 0x000060, "Wrong size on UMovieSceneTransformOriginInstantiatorSystem");
...
static_assert(sizeof(UMovieSceneTransformOriginSystem) == 0x000098, "Wrong size on UMovieSceneTransformOriginSystem");
...
static_assert(sizeof(UMovieSceneDoubleVectorPropertySystem) == 0x000078, "Wrong size on UMovieSceneDoubleVectorPropertySystem");
...
static_assert(sizeof(UObjectPathChannelEvaluatorSystem) == 0x000060, "Wrong size on UObjectPathChannelEvaluatorSystem");
...
static_assert(sizeof(UStringChannelEvaluatorSystem) == 0x000060, "Wrong size on UStringChannelEvaluatorSystem");
...
{
public:
	class UMovieSceneHierarchicalEasingInstantiatorSystem* InstantiatorSystem;                                // 0x0060(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneHierarchicalEasingFinalizationSystem) == 0x000068, "Wrong size on UMovieSceneHierarchicalEasingFinalizationSystem");
static_assert(offsetof(UMovieSceneHierarchicalEasingFinalizationSystem, InstantiatorSystem) == 0x000060, "Member 'UMovieSceneHierarchicalEasingFinalizationSystem::InstantiatorSystem' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraCutTrackInstance) == 0x0000E8, "Wrong size on UMovieSceneCameraCutTrackInstance");
...
{
public:
	TArray<class UMovieSceneSection*>             ConstraintSections;                                // 0x00B8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieScene3DConstraintTrack) == 0x0000C8, "Wrong size on UMovieScene3DConstraintTrack");
...
static_assert(sizeof(UMovieScene3DAttachTrack) == 0x0000C8, "Wrong size on UMovieScene3DAttachTrack");
...
public:
	...
	TSubclassOf<class UMovieSceneBlenderSystem>   BlenderSystemClass;                                // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieScene3DTransformTrack) == 0x0000F8, "Wrong size on UMovieScene3DTransformTrack");
static_assert(offsetof(UMovieScene3DTransformTrack, BlenderSystemClass) == 0x0000F0, "Member 'UMovieScene3DTransformTrack::BlenderSystemClass' has a wrong offset!");
...
{
public:
	TArray<class UMovieSceneSection*>             AudioSections;                                     // 0x00B8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneAudioTrack) == 0x0000C8, "Wrong size on UMovieSceneAudioTrack");
...
{
public:
	class UEnum*                                  Enum;                                              // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMovieSceneByteTrack, Enum) == 0x0000E8, "Member 'UMovieSceneByteTrack::Enum' has a wrong offset!");
...
{
public:
	bool                                          bCanBlend;                                         // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneCameraCutTrack, bCanBlend) == 0x0000B8, "Member 'UMovieSceneCameraCutTrack::bCanBlend' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutTrack, Sections) == 0x0000C0, "Member 'UMovieSceneCameraCutTrack::Sections' has a wrong offset!");
...
public:
	uint8                                         Pad_B8[0x8];                                       // 0x00B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             CameraShakeSections;                               // 0x00C0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCameraShakeSourceShakeTrack) == 0x0000D0, "Wrong size on UMovieSceneCameraShakeSourceShakeTrack");
static_assert(offsetof(UMovieSceneCameraShakeSourceShakeTrack, CameraShakeSections) == 0x0000C0, "Member 'UMovieSceneCameraShakeSourceShakeTrack::CameraShakeSections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceTriggerTrack) == 0x0000D0, "Wrong size on UMovieSceneCameraShakeSourceTriggerTrack");
static_assert(offsetof(UMovieSceneCameraShakeSourceTriggerTrack, Sections) == 0x0000C0, "Member 'UMovieSceneCameraShakeSourceTriggerTrack::Sections' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneCameraShakeTrack, CameraShakeSections) == 0x0000C0, "Member 'UMovieSceneCameraShakeTrack::CameraShakeSections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCinematicShotTrack) == 0x0000C8, "Wrong size on UMovieSceneCinematicShotTrack");
...
{
public:
	bool                                          bIsSlateColor;                                     // 0x00E8(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneColorTrack, bIsSlateColor) == 0x0000E8, "Member 'UMovieSceneColorTrack::bIsSlateColor' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCVarTrack) == 0x0000C8, "Wrong size on UMovieSceneCVarTrack");
static_assert(offsetof(UMovieSceneCVarTrack, Sections) == 0x0000B8, "Member 'UMovieSceneCVarTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDataLayerTrack) == 0x0000C8, "Wrong size on UMovieSceneDataLayerTrack");
static_assert(offsetof(UMovieSceneDataLayerTrack, Sections) == 0x0000B8, "Member 'UMovieSceneDataLayerTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDoubleTrack) == 0x0000E8, "Wrong size on UMovieSceneDoubleTrack");
...
static_assert(offsetof(UMovieSceneEnumTrack, Enum) == 0x0000E8, "Member 'UMovieSceneEnumTrack::Enum' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEulerTransformTrack) == 0x0000E8, "Wrong size on UMovieSceneEulerTransformTrack");
...
public:
	...
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x00D0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneFadeTrack) == 0x0000E8, "Wrong size on UMovieSceneFadeTrack");
...
static_assert(sizeof(UMovieSceneIntegerTrack) == 0x0000E8, "Wrong size on UMovieSceneIntegerTrack");
...
static_assert(sizeof(UMovieSceneLevelVisibilityTrack) == 0x0000C8, "Wrong size on UMovieSceneLevelVisibilityTrack");
...
public:
	...
	class UMaterialParameterCollection*           MPC;                                               // 0x00E0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneMaterialParameterCollectionTrack) == 0x0000E8, "Wrong size on UMovieSceneMaterialParameterCollectionTrack");
static_assert(offsetof(UMovieSceneMaterialParameterCollectionTrack, MPC) == 0x0000E0, "Member 'UMovieSceneMaterialParameterCollectionTrack::MPC' has a wrong offset!");
...
public:
	uint8                                         Pad_D0[0x10];                                      // 0x00D0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaterialIndex;                                     // 0x00E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneComponentMaterialTrack) == 0x0000E8, "Wrong size on UMovieSceneComponentMaterialTrack");
static_assert(offsetof(UMovieSceneComponentMaterialTrack, MaterialIndex) == 0x0000E0, "Member 'UMovieSceneComponentMaterialTrack::MaterialIndex' has a wrong offset!");
...
public:
	uint8                                         Pad_E8[0x8];                                       // 0x00E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UObject>                    PropertyClass;                                     // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneObjectPropertyTrack) == 0x0000F8, "Wrong size on UMovieSceneObjectPropertyTrack");
static_assert(offsetof(UMovieSceneObjectPropertyTrack, PropertyClass) == 0x0000F0, "Member 'UMovieSceneObjectPropertyTrack::PropertyClass' has a wrong offset!");
...
public:
	uint8                                         Pad_B8[0x8];                                       // 0x00B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             ParticleSections;                                  // 0x00C0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneParticleTrack, ParticleSections) == 0x0000C0, "Member 'UMovieSceneParticleTrack::ParticleSections' has a wrong offset!");
...
{
public:
	int32                                         MaterialIndex;                                     // 0x00E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_EC[0x4];                                       // 0x00EC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieScenePrimitiveMaterialTrack) == 0x0000F0, "Wrong size on UMovieScenePrimitiveMaterialTrack");
static_assert(offsetof(UMovieScenePrimitiveMaterialTrack, MaterialIndex) == 0x0000E8, "Member 'UMovieScenePrimitiveMaterialTrack::MaterialIndex' has a wrong offset!");
...
{
public:
	TArray<class UMovieSceneSection*>             AnimationSections;                                 // 0x00B8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	bool                                          bUseLegacySectionIndexBlend;                       // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSkeletalAnimRootMotionTrackParams RootMotionParams;                                  // 0x00D0(0x0080)(NoDestructor, NativeAccessSpecifierPublic)
	...
	ESwapRootBone                                 SwapRootBone;                                      // 0x0151(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, RootMotionParams) == 0x0000D0, "Member 'UMovieSceneSkeletalAnimationTrack::RootMotionParams' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, SwapRootBone) == 0x000151, "Member 'UMovieSceneSkeletalAnimationTrack::SwapRootBone' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneStringTrack) == 0x0000E8, "Wrong size on UMovieSceneStringTrack");
...
static_assert(sizeof(UMovieSceneTransformTrack) == 0x0000E8, "Wrong size on UMovieSceneTransformTrack");
...
static_assert(sizeof(UMovieSceneFloatVectorTrack) == 0x0000F0, "Wrong size on UMovieSceneFloatVectorTrack");
static_assert(offsetof(UMovieSceneFloatVectorTrack, NumChannelsUsed) == 0x0000E8, "Member 'UMovieSceneFloatVectorTrack::NumChannelsUsed' has a wrong offset!");
