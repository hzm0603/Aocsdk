...
{
public:
	uint8                                         Pad_48[0xD50];                                     // 0x0048(0x0D50)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000D98, "Wrong size on UAssetRegistryImpl");
