...
static_assert(sizeof(UHandlerComponentFactory) == 0x000048, "Wrong size on UHandlerComponentFactory");
...
{
public:
	TArray<class FString>                         Components;                                        // 0x0048(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPacketHandlerProfileConfig) == 0x000058, "Wrong size on UPacketHandlerProfileConfig");
static_assert(offsetof(UPacketHandlerProfileConfig, Components) == 0x000048, "Member 'UPacketHandlerProfileConfig::Components' has a wrong offset!");
