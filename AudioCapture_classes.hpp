...
static_assert(sizeof(UAudioCapture) == 0x0000D0, "Wrong size on UAudioCapture");
...
static_assert(sizeof(UAudioCaptureFunctionLibrary) == 0x000048, "Wrong size on UAudioCaptureFunctionLibrary");
...
static_assert(sizeof(UAudioCaptureBlueprintLibrary) == 0x000048, "Wrong size on UAudioCaptureBlueprintLibrary");
...
{
public:
	int32                                         JitterLatencyFrames;                               // 0x0980(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_984[0xBC];                                     // 0x0984(0x00BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioCaptureComponent) == 0x000A40, "Wrong size on UAudioCaptureComponent");
static_assert(offsetof(UAudioCaptureComponent, JitterLatencyFrames) == 0x000980, "Member 'UAudioCaptureComponent::JitterLatencyFrames' has a wrong offset!");
