...
static_assert(sizeof(UNiagaraMergeable) == 0x000048, "Wrong size on UNiagaraMergeable");
...
static_assert(sizeof(UNiagaraDataInterfaceBase) == 0x000048, "Wrong size on UNiagaraDataInterfaceBase");
