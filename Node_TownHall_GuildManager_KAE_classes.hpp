...
// Package: Node_TownHall_GuildManager_KAE
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Node_TownHall_GuildManager_KAE_C">();
	}
	static class ANode_TownHall_GuildManager_KAE_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ANode_TownHall_GuildManager_KAE_C>();
	}
};
