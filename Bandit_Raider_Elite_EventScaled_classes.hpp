...
// Package: Bandit_Raider_Elite_EventScaled
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Bandit_Raider_Elite_EventScaled_C">();
	}
	static class ABandit_Raider_Elite_EventScaled_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABandit_Raider_Elite_EventScaled_C>();
	}
};
