...
static_assert(alignof(WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton) == 0x000008, "Wrong alignment on WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton");
static_assert(sizeof(WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton) == 0x000138, "Wrong size on WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton");
static_assert(offsetof(WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton, EntryPoint) == 0x000000, "Member 'WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton::EntryPoint' has a wrong offset!");
static_assert(offsetof(WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton, K2Node_Event_MouseEvent_1) == 0x000008, "Member 'WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton::K2Node_Event_MouseEvent_1' has a wrong offset!");
static_assert(offsetof(WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton, K2Node_Event_MyGeometry) == 0x000080, "Member 'WBP_WorldMapIconButton_C_ExecuteUbergraph_WBP_WorldMapIconButton::K2Node_Event_MyGeometry' has a wrong offset!");
