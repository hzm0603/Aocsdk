...
#include "WBP_CommodityCategoryGrid_classes.hpp"
#include "WBP_CommodityCategoryGrid_parameters.hpp"
...
void UWBP_CommodityCategoryGrid_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CommodityCategoryGrid_C", "PreConstruct");
