...
struct NPC_Spider_AnimBP_C_AnimGraph final
{
public:
	struct FPoseLink                              AnimGraph_0;                                       // 0x0000(0x0010)(Parm, OutParm, NoDestructor)
};
static_assert(alignof(NPC_Spider_AnimBP_C_AnimGraph) == 0x000008, "Wrong alignment on NPC_Spider_AnimBP_C_AnimGraph");
static_assert(sizeof(NPC_Spider_AnimBP_C_AnimGraph) == 0x000010, "Wrong size on NPC_Spider_AnimBP_C_AnimGraph");
static_assert(offsetof(NPC_Spider_AnimBP_C_AnimGraph, AnimGraph_0) == 0x000000, "Member 'NPC_Spider_AnimBP_C_AnimGraph::AnimGraph_0' has a wrong offset!");

// Function NPC_Spider_AnimBP.NPC_Spider_AnimBP_C.BlueprintUpdateAnimation
// 0x0004 (0x0004 - 0x0000)
struct NPC_Spider_AnimBP_C_BlueprintUpdateAnimation final
{
public:
	float                                         DeltaTimeX;                                        // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(NPC_Spider_AnimBP_C_BlueprintUpdateAnimation) == 0x000004, "Wrong alignment on NPC_Spider_AnimBP_C_BlueprintUpdateAnimation");
static_assert(sizeof(NPC_Spider_AnimBP_C_BlueprintUpdateAnimation) == 0x000004, "Wrong size on NPC_Spider_AnimBP_C_BlueprintUpdateAnimation");
