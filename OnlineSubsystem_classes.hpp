...
{
public:
	TArray<struct FNamedInterface>                NamedInterfaces;                                   // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNamedInterfaceDef>             NamedInterfaceDefs;                                // 0x0058(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNamedInterfaces) == 0x000080, "Wrong size on UNamedInterfaces");
static_assert(offsetof(UNamedInterfaces, NamedInterfaces) == 0x000048, "Member 'UNamedInterfaces::NamedInterfaces' has a wrong offset!");
