...
{
public:
	TArray<struct FSoundVariation>                Variations;                                        // 0x0188(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class USoundWave*                             SoundWave;                                         // 0x0198(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USoundSimple) == 0x0001A0, "Wrong size on USoundSimple");
static_assert(offsetof(USoundSimple, Variations) == 0x000188, "Member 'USoundSimple::Variations' has a wrong offset!");
static_assert(offsetof(USoundSimple, SoundWave) == 0x000198, "Member 'USoundSimple::SoundWave' has a wrong offset!");
...
static_assert(sizeof(USoundUtilitiesBPFunctionLibrary) == 0x000048, "Wrong size on USoundUtilitiesBPFunctionLibrary");
