...
static_assert(alignof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails) == 0x000008, "Wrong alignment on WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails");
static_assert(sizeof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails) == 0x000038, "Wrong size on WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails");
static_assert(offsetof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails, EntryPoint) == 0x000000, "Member 'WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails::EntryPoint' has a wrong offset!");
static_assert(offsetof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails, CallFunc_Create_ReturnValue) == 0x000008, "Member 'WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails, CallFunc_AddChild_ReturnValue) == 0x000018, "Member 'WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails::CallFunc_AddChild_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails, CallFunc_HasAnyChildren_ReturnValue) == 0x000020, "Member 'WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails::CallFunc_HasAnyChildren_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails, Temp_int_Variable) == 0x000024, "Member 'WBP_BuildingDetails_C_ExecuteUbergraph_WBP_BuildingDetails::Temp_int_Variable' has a wrong offset!");
