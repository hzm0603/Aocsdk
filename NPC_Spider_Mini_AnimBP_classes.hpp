...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"NPC_Spider_Mini_AnimBP_C">();
	}
	static class UNPC_Spider_Mini_AnimBP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UNPC_Spider_Mini_AnimBP_C>();
	}
};
