...
// Package: ArtisanshipPOI_Woodshop_General
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ArtisanshipPOI_Woodshop_General_C">();
	}
	static class AArtisanshipPOI_Woodshop_General_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AArtisanshipPOI_Woodshop_General_C>();
	}
};
