...
static_assert(sizeof(UMobileInstalledContent) == 0x000068, "Wrong size on UMobileInstalledContent");
...
static_assert(sizeof(UMobilePendingContent) == 0x0000A8, "Wrong size on UMobilePendingContent");
...
static_assert(sizeof(UMobilePatchingLibrary) == 0x000048, "Wrong size on UMobilePatchingLibrary");
